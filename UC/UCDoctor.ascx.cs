...
public partial class UC_UCDoctor : System.Web.UI.UserControl
{
    ...
    public void BindGrid()
    {
        ...
        theCommand.CommandText = "select doc_id,doc_name from GN_DoctorMaster where compcode='" + Session["CoCode"].ToString() + "'";
