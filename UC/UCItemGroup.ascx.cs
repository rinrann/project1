...
public partial class UCItemGroup : System.Web.UI.UserControl
{
    ...
    public void BindGrid()
    {
        ...
        theCommand.CommandText = "select MedicineGroupID,MedicineGroupName from IPD_MedicineGroup where compcode='" + Session["CoCode"].ToString() + "'";
