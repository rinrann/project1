...
public partial class View_PatientFeesCollection : System.Web.UI.Page
{
    ...
    public void bind_report()
    {
        ...
        rpt.Append("<td style='width: 8%; font-family:Courier New;font-weight:bold; text-align:Center;padding-bottom:10px'><br/> <u>Patient Registration Collection Register</u></td>");
        rpt.Append("</tr'>");
        rpt.Append("</table>");


        rpt.Append("<table width='100%' border=1 bordercolor=silver cellspacing=0   style='font-family:Courier New;font-size:small;'>");
        ...
        rpt.Append("<td style='width:2%;'>Age</td>");
        rpt.Append("<td style='width:2%;'>Sex</td>");
        rpt.Append("<td style='width:10%;'>Address</td>");
        rpt.Append("<td style='width:5%;'>Phone</td>");
        rpt.Append("<td style='width:10%;'>Doctor</td>");
        rpt.Append("<td style='width:5%;text-align:right'>Fees</td>");
        rpt.Append("<td style='width:5%;text-align:right'>By Cash</td>");
        rpt.Append("<td style='width:5%;text-align:right'>By Bank</td>");
        rpt.Append("<td style='width:5%;text-align:right'>Net</td>");
        rpt.Append("</tr>");
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            {
                rpt.Append("</tr>"); 
                rpt.Append("<td style='font-weight:bold;' colspan=9>" + dt.Rows[i]["PatientName"].ToString() + "</td>");
            ...
            else
            {
                ...
                rpt.Append("<td>" + dt.Rows[i]["Age"].ToString() + "</td>");
                rpt.Append("<td>" + dt.Rows[i]["Sex"].ToString() + "</td>");
                rpt.Append("<td>" + dt.Rows[i]["Addr"].ToString() + "</td>");
                rpt.Append("<td>" + dt.Rows[i]["Phno"].ToString() + "</td>");
    ...
    protected void cmd_excel_Click(object sender, EventArgs e)
    {
        ...
        Response.Charset = "";
        Response.AppendHeader("content-disposition", "attachment; filename=PatientFeesCollection.xls");
