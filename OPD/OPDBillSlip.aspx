<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="OPDBillSlip.aspx.cs" Inherits="OPD_OPDBillSlip" %>
...
<script language="javascript" type="text/javascript">
    ...
    function ShowDialog() {
        ...
        var rtvalue = window.open("PtientDetailspopup.aspx?status=1", "sss", "Width:800px; Height:550px; dialogLeft:250px;");
        document.getElementById("ctl00_ContentPlaceHolder1_txtreg").value = rtvalue.NameValue;
    }

    function ShowDialogDuplicate() {

        var rtvalue = window.open("PtientDetailspopup.aspx?status=0", "sss", "Width:800px; Height:550px; dialogLeft:250px;");
     ...
     <div class="formbox">
        <div class="form-sec">
           ...
           <td colspan="6" align="center">
               <asp:RadioButtonList ID="RadioButtonList2" runat="server"  Width="60%"
                   RepeatDirection="Horizontal" AutoPostBack="True" 
                   onselectedindexchanged="RadioButtonList2_SelectedIndexChanged">
                   <asp:ListItem Selected="True" Value="Current Report">Current Report For Existing Patient</asp:ListItem>
                   <asp:ListItem Value="Duplicate Report">Duplicate Report For CheckOut Patient</asp:ListItem>
               </asp:RadioButtonList>
               </td>
           </tr>
           </table>
