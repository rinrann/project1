<%@ Page Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="MenuDetails.aspx.cs" Inherits="Master_MenuDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    function Calling() {
        $("input[id$='txtMenuName']").focus(function () {
            $("input[id$='txtMenuName']").addClass('textboxborder');
        });
        $("input[id$='txtMenuName']").blur(function () {
            $("input[id$='txtMenuName']").removeClass('textboxborder');
        });
        $("input[id$='Button1']").click(function () {
            if ($("input[id$='txtMenuName']").val() == '') {
                $("input[id$='txtMenuName']").addClass('textboxerr');
            }
            if ($("input[id$='txtMenuName']").val() == '') {
                alert('Menu Name Can not be Blank!');
                $("input[id$='txtMenuName']").focus();
                $("input[id$='txtMenuName']").addClass('textboxerr');
                return false;
            }
            else {
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="pageheader">
                <asp:Label ID="Label1" runat="server">Menu Details</asp:Label>
            </div>
            ...
            <div class="formbox">
             <asp:MultiView ID="MainView" runat="server">
               ...
               <%--     <div class="form-sec-row">
                        <label>
                        <strong>Menu ID :</strong></label>
                        <asp:TextBox ID="txtMenuId" runat="server" CssClass="textbox-medium1" 
                    ...
                    <div class="form-sec-row">
                        ...
                        <asp:TextBox ID="txtMenuName" runat="server" CssClass="textbox-medium1" ></asp:TextBox>
                        <div class="clear">
                        </div>
                    </div>
                     <div class="form-sec-row">
                    ...
                    <div class="clear">
                     ...
                     <div class="form-sec-row">
                        ...
                        <strong> 
                        URL :</strong></label>
                        <asp:TextBox ID="txtURL" runat="server" CssClass="textbox-medium1" ></asp:TextBox>
                        <div class="clear">
                        </div>
                    </div>
         ...
         <td> <asp:DropDownList ID="ddlModuleSearch" Width="180px" AutoPostBack="true"  
                ...
                <td><strong>Sub-Module :</strong></td>
         <td> <asp:DropDownList ID="ddlSubModuleSearch" Width="180px" AutoPostBack="true"  
                 runat="server" 
                 onselectedindexchanged="ddlSubModuleSearch_SelectedIndexChanged" >
             </asp:DropDownList></td>  
      ...
      <div class="listing" style='height:500px; width:100%; overflow:auto;'>
                <asp:GridView id="GridView1"  CssClass="grid" PagerStyle-CssClass="pgr"
                 DataKeyNames ="MenuID" runat="server"  PageSize="1000"
                 ...
                 OnPageIndexChanging="GridView1_PageIndexChanging" >
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="SubModule Name" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                        <asp:Label ID="SubModuleName" runat="server" Text='<%#Bind("SubModuleName") %>'></asp:Label>
                        </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="URL" Visible="true" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:Label ID="URL" runat="server" Text='<%# Bind("URL") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
