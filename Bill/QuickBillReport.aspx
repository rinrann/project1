<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="QuickBillReport.aspx.cs" Inherits="Bill_QuickBillReport" %>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Quick Bill Details</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
           ...
           <td>  
               <asp:TextBox ID="txtreg" CssClass="textbox-medium1" runat="server"  Enabled="false" 
                    ...
                    <tr>
                       ...
                       <td align="center" colspan="">
                         ...
                         <input type="button" id="cmdPrint" value="Print" style="width:70px; font-size:x-small" onclick="javascript:printDiv('mydiv')"/>
                           <asp:Button ID="Button5" runat="server" onclick="Button1_Click" style="width:70px; font-size:x-small" Text="PDF" />
