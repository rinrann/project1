<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="HospitalsDetailsReport.aspx.cs" Inherits="Pathology_HospitalsDetailsReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Hospitals Information</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
