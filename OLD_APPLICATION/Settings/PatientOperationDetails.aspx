<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="PatientOperationDetails.aspx.cs" Inherits="Assignment_PatientOperationDetails" %>
...
<script language="javascript" type="text/javascript">
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
  ...
  <div class="pageheader">
         <asp:Label ID="Label1" runat="server"> Patient Operation Report</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
           ...
           <tr>
            ...
            <td>  <label><strong>From Date:</strong></label> </td>
              ...
              <td> 
                  <asp:Button ID="btnSearch" runat="server"  CssClass="submit-generate" 
              ...
              <table width="100%">
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <asp:Button ID="btnPDF" runat="server"  style="width:70px; font-size:x-small" Text="PDF"/>  
