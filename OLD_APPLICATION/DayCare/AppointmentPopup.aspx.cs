...
public partial class DayCare_AppointmentPopup : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Page.Title = "Appointment Popup";
        GridFill();
    }
    public void GridFill()
    {
        GridView1.DataSource = thereg.GridAppointmentPopup(txtreg.Text.Trim(), txtname.Text.Trim(), txtph.Text.Trim(), txtaddress.Text.Trim(),Session["CoCode"].ToString().Trim());
        GridView1.DataBind();
    }
