<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="DialiserTypeMaster.aspx.cs" Inherits="DayCare_DialiserTypeMaster" %>
        ...
        function Calling() {
            $("input[id$='Button1']").click(function () {
                if ($("input[id$='txtchemicalname']").val() == '') {
                    alert('Please Enter Dialyser Type Name !');
 ...
 <%--
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Dialysis Type Master</asp:Label>
     </div>
     ...
     <asp:HiddenField ID="HiddenField1" runat="server" />
			<div class="form-sec-row">
                <label><strong>Dialysis Type Name :</strong></label>
                 <asp:TextBox ID="txtchemicalname" runat="server" CssClass="textbox-medium1" 
                   ></asp:TextBox>
                 <cc1:AutoCompleteExtender ServiceMethod="SearchType" OnClientItemSelected="autoCompleteEx_ItemSelected" MinimumPrefixLength="1"
     ...
     <div class="listing">
         <asp:GridView id="GridView1"  CssClass="grid"
                 PagerStyle-CssClass="pgr" DataKeyNames ="TypeId" runat="server" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Id" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="lblID" runat="server" Text='<%# Bind("TypeId") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="TYPE NAME ">
                       
                        <ItemTemplate>
                            <asp:Label ID="lblname" runat="server" Text='<%# Bind("TypeName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
