<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppointmentPopup.aspx.cs" Inherits="DayCare_AppointmentPopup" %>
...
<td>
          ...
          <td>
           ...
           <asp:Button ID="Button2" runat="server" Text="Search"  CssClass="submit-button" onclick="Button2_Click"  Height="28px"
             ...
             <tr align="center">                       
                   <td colspan="5">
                   <div class="listing"  style='width:100%; height:380px; overflow:auto;'>
