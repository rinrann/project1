<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="ChemicalList.aspx.cs" Inherits="DayCare_ChemicalList" %>
 ...
 <script language="javascript" type="text/javascript">
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Chemical list</asp:Label>
     </div>
      ...
      <asp:MultiView ID="MainView" runat="server">
        ...
        <div class="form-sec">
			...
			<div class="form-sec-row">
                <label><strong>Chemical Name :</strong></label>
            ...
            <div class="form-sec-row">
                <label><strong>Chemical Used / Dialysis :</strong></label>
    ...
    <td style='width:110px;' align="center">Unit</td>
     ...
     <div class="listing" style=' height:500px; overflow:auto;'>
         <asp:GridView id="GridView1"  CssClass="grid" ShowHeader="false"
                 PagerStyle-CssClass="pgr" DataKeyNames ="ID,ChemicalName" runat="server" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Id" Visible="false">
                     ...
                     <asp:TemplateField HeaderText="Item id" Visible ="false">                       
                        <ItemTemplate>
                            <asp:Label ID="lbliChemicalName" runat="server" Text='<%# Bind("ChemicalName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
