<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DialysisPopup.aspx.cs" Inherits="DayCare_DialysisPopup" %>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    <ProgressTemplate>
       ...
       <tr>
             ...
             <label class="pname"><strong>Date :</strong></label> 
                      <asp:TextBox ID="txtdate" runat="server" CssClass="textbox-medium1" Width="138px" ></asp:TextBox> </div>
            
</td>
                <td>
                    <div class="form-sec-row"> 
             <label class="pname"><strong>Shift :</strong></label> 
                ...
                <td>
                             <div class="form-sec-row"> 
             <label class="pname"><strong>Name :</strong></label> <asp:TextBox ID="txtname" runat="server" CssClass="textbox-medium1" Width="138px" ></asp:TextBox>
            </div>                  
</td>
<td>
                             <div class="form-sec-row"> 
           ...
           <asp:Button ID="Button2" runat="server" Text="Search"  Height="28px" CssClass="submit-button1" 
             ...
             <tr align="center">                       
                   <td colspan="5">
                   <div class="listing"  style='width:100%; height:350px; overflow:auto;'>
                  <asp:GridView id="GridView_popup" CssClass="grid" PagerStyle-CssClass="pgr" DataKeyNames ="PatientReg" 
                 ...
                 Width="100%" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" 
                           CellPadding="2" ForeColor="Black" GridLines="None"  SelectedRowStyle-BackColor="GreenYellow"
                           onrowcommand="GridView_popup_RowCommand" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="District">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblperadd" runat="server" Text='<%# Bind("District") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Nationality">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblnation" runat="server" Text='<%# Bind("nationalility") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <tr>
            ...
            <td  >
                ...
                <input id="btnClose" type="button" style='height:28px;'  class="submit-button" value="Ok"  onclick="CloseDialog();" />
             <input id="Button1" type="button" style='height:28px;'  value="Cancel" class="submit-button" onclick="return Button1_onclick()" /> 
