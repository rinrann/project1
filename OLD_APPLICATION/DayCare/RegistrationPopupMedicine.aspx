<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistrationPopupMedicine.aspx.cs" Inherits="DayCare_RegistrationPopupMedicine" %>
  ...
  margin-right:auto; 
    ...
    <script type="text/javascript" >
        ...
        function CloseDialog() {
            ...
            window.opener.document.getElementById("ctl00_ContentPlaceHolder1_TextBox23").value = arg.NameValue;
            window.opener.document.getElementById("ctl00_ContentPlaceHolder1_TextBox24").value = a[0];
            window.close();
    ...
    <%--For Busy Loader End.............................--%>
       ...
       <tr>
             ...
             <label class="pname"><strong>Date :</strong></label> 
                      <asp:TextBox ID="txtdate" runat="server" CssClass="textbox-medium1" Width="138px" ></asp:TextBox>  <div class="clear">
            </div>
...
<td>
          ...
          <td>
                             <div class="form-sec-row"> 
           <asp:Button ID="Button2" runat="server" Text="Search"  CssClass="submit-button" onclick="Button2_Click"  Height="28px"
                                />
            </div>                  
</td>             
