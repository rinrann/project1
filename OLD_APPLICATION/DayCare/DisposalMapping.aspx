<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="DisposalMapping.aspx.cs" Inherits="DayCare_DisposalMapping" %>
...
<%--  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Disposable Mapping</asp:Label>
    </div>
     <div class="formbox">
      <div class="error">
  ...
  <tr style='border:1px solid black;'> 
   ...
   <td style='width:110px;'  align="center">Group</td>
    <td style='width:110px;' align="center">Sub Group</td>
     <td style='width:110px;' align="center">Disposable Item</td>
      <td style='width:110px;' align="center">Used For</td>
       <td style='width:110px;' align="center">Unit</td>
         ...
         <asp:GridView id="GridView1" style="width:100%;" CssClass="grid" 
            ...
            runat="server" AutoGenerateColumns="False" AllowPaging="True" 
             PageSize ="10" onpageindexchanging="GridView1_PageIndexChanging" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="ID" Visible="false">
                        <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Group"  ItemStyle-Width="110px"   ItemStyle-HorizontalAlign="Center" >
                        <ItemTemplate>
                            <asp:Label ID="lblDIALYSIS" runat="server" Text="DIALYSIS"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Sub Group"  ItemStyle-Width="110px"  ItemStyle-HorizontalAlign="Center" >
                        <ItemTemplate>
                            <asp:Label ID="lblCHEMICAL" runat="server" Text="DISPOSABLE"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>


                    <asp:TemplateField HeaderText="Stock Disposable Items"   ItemStyle-Width="110px"   ItemStyle-HorizontalAlign="Center" >
                        <ItemTemplate>
                            <asp:Label ID="lblname" runat="server" Text='<%# Bind("MedicineName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                           <asp:TemplateField HeaderText="Used For" ItemStyle-Width="110px"   ItemStyle-HorizontalAlign="Center" >
                        <ItemTemplate>
                ...
                <asp:Button ID="Button4" runat="server"  Height="28px" Text="Cancel"  CssClass="submit-button" />
                <div class="clear"></div>
            </div>
            </div>
    </ContentTemplate>
