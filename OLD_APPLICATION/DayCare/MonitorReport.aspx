<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="MonitorReport.aspx.cs" Inherits="DayCare_MonitorReport" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Monitoring Report</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
