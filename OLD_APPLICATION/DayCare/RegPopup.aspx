<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegPopup.aspx.cs" Inherits="DayCare_RegPopup" %>
                ...
                <Columns>
                    <asp:CommandField SelectText="Select" ShowSelectButton="True" />
                       ...
                       <asp:TemplateField HeaderText="Appointment No">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="AppNo" runat="server" Text='<%# Bind("AppNo") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Patient Name">
                     ...
                     <asp:TemplateField HeaderText="Local Address" >
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblladd" runat="server" Text='<%# Bind("PAddress") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
