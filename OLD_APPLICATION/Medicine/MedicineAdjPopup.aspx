<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MedicineAdjPopup.aspx.cs" Inherits="Medicine_MedicineAdjPopup" %>
          ...
          <td>
           ...
           <asp:Button ID="Button2" runat="server" Text="Search"  CssClass="submit-button1" onclick="Button2_Click"  Height="28px"
             ...
             <tr align="center">                       
                  ...
                  <asp:GridView id="GridView_popup" CssClass="grid" PagerStyle-CssClass="pgr" DataKeyNames ="docno" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="DocNo" >
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblid" runat="server" Text='<%# Bind("docno") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Date">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblpdate" runat="server" Text='<%# Bind("docdt") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                         <asp:TemplateField HeaderText="Total Purchase" Visible="false">
                       
                        <ItemTemplate>
                            <asp:Label ID="lbltotalpurchase" runat="server" Text='<%# Bind("billvalue") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
