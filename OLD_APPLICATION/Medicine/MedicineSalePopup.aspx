<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MedicineSalePopup.aspx.cs" Inherits="Medicine_MedicineSalePopup" %>
  ...
  margin-right:auto; 
    ...
    <script type="text/javascript" >
        function CloseDialog() {
            ...
            window.opener.document.getElementById("ctl00_ContentPlaceHolder1_TextBox5").value = arg.NameValue;
            window.opener.document.getElementById("ctl00_ContentPlaceHolder1_txtBillNo").value = arg.ProfessionValue;
            window.close();
       ...
       <tr>
          ...
          <td>
           ...
           <asp:Button ID="Button2" runat="server" Text="Search"  Height="28px" CssClass="submit-button1" onclick="Button2_Click" 
             ...
             <tr align="center">                       
                  ...
                  <asp:GridView id="GridView_popup" CssClass="grid" PagerStyle-CssClass="pgr" DataKeyNames ="salesbillno" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sales/Issue Bill No" >
                       
                        <ItemTemplate>
                            <asp:Label ID="lblid" runat="server" Text='<%# Bind("salesbillno") %>' Visible="false"></asp:Label>
                            <asp:Label ID="iblbillno" runat="server" Text='<%# Bind("REFBILLNO") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                      ...
                      <asp:TemplateField HeaderText="Issue to">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblsname" runat="server" Text='<%# Bind("IssueTo") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Issue Date">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblpdate" runat="server" Text='<%# Bind("SaleDate") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <asp:HiddenField ID="HiddenField1" runat="server" Value="" />
                <asp:HiddenField ID="HiddenField2" runat="server" />
                 ...
                 <td >
             <input id="btnClose" type="button" class="submit-button1"  value="Ok" onclick="CloseDialog();" />
          <input id="Button1" type="button" value="Cancel"   class="submit-button1" onclick="return Button1_onclick()"" /> 
