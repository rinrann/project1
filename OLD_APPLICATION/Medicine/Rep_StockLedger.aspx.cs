...
public partial class Rep_StockLedger : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "STOCK LEDGER", checkAccessType.ViewAction) == false)
        {
    ...
    protected void btnproceed_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("View_StockLedger.aspx");
