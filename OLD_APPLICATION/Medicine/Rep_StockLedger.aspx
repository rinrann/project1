<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="Rep_StockLedger.aspx.cs" Inherits="Rep_StockLedger" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function DisableBackButton() {
         ...
         <asp:Label ID="Label1" runat="server">Stock Ledger</asp:Label>
     </div>
