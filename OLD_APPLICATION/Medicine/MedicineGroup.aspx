<%@ Page Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="MedicineGroup.aspx.cs" Inherits="Master_MedicineGroup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function autoCompleteEx_ItemSelected(sender, args) {
            ...
            document.getElementById("ctl00_ContentPlaceHolder1_txtMedicineGroupName").value = regname[0];
...
<%-- 
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="pageheader">
                <asp:Label ID="Label1" runat="server">Medicine Group</asp:Label>
            </div>
            ...
            <div class="formbox">
             <asp:MultiView ID="MainView" runat="server">
               ...
               <%--     <div class="form-sec-row">
                        <label><strong> 
                        MedicineGroup ID:</strong></label>
                        <asp:TextBox ID="txtMedicineGroupId" runat="server" CssClass="textbox-medium1" 
                    ...
                    <div class="form-sec-row">
                        <label><strong> 
                        MedicineGroup Name :</strong></label>
  ...
  <tr style='border:1px solid black;'> 
   <td style='width:150px;' align="center">MedicineGroup Name</td> 
          ...
          <td style='width:70px;' align="center" id="coldel" runat="server">Delete</td>
            ...
            <div class="listing"  style='width:100%; height:500px; overflow:auto;'>
                <asp:GridView id="GridView1"  Width="100%" CssClass="grid" PagerStyle-CssClass="pgr"
                 DataKeyNames ="MedicineGroupID" runat="server"  PageSize="1000"
                 ...
                 OnPageIndexChanging="GridView1_PageIndexChanging" SelectedRowStyle-BackColor="GreenYellow">
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="MedicineGroup ID" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="MedicineGroupID" runat="server" Text='<%# Bind("MedicineGroupID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="MedicineGroup Name"  ItemStyle-Width="150px">
                            <ItemTemplate>
