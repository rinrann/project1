...
public partial class Bill_QuickBillReport : System.Web.UI.Page
{
    ...
    {
        Page.Title = "Quick Bill Details";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "QUICK BILL DETAILS", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
        ...
        { 
            ...
            DataSet bill = thepatientbill.QuickBedBill(txtreg.Text, cocode);
            ...
            if (dtbill.Rows.Count > 0)
            {
                ...
                rpt.Append("<td style='width: 1%;border-bottom: 1px solid black;font-family:Verdana;font-weight:bold;background-color:#9B9C8D; font-size:small; text-align:center'>No of Days</td>");
                ...
                for (int i = 0; i < dtbill.Rows.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        rpt.AppendFormat("<td  style='width: 1%;font-family:Verdana; font-size:small; text-align:center'>{0}</td>", dtbill.Rows[i]["DateDifference"]);
                ...
                rpt.Append("</tr >");
                /*if (Convert.ToDecimal(dtbill.Rows[0]["advamount"]) > 0)
                {
                    rpt.Append("<tr style='height:25px'>");
                    rpt.Append("<td colspan='5' style='width: 8%;border-bottom: 1px solid black;border-top: 1px solid black;font-family:Verdana;font-weight:bold;background-color:#F6B2B2; font-size:small; text-align:center'>Advance Paid : -</td>");
                    rpt.AppendFormat("<td  style='width: 8%;border-top: 1px solid black;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#F6B2B2; font-size:small; text-align:right'>{0}</td>", dtbill.Rows[0]["advamount"]);
                    rpt.Append("</tr >");
                    rpt.Append("<tr style='height:25px'>");
                    rpt.Append("<td colspan='5' style='width: 8%;border-bottom: 1px solid black;border-top: 1px solid black;font-family:Verdana;font-weight:bold;background-color:#F6B2B2; font-size:small; text-align:center'>Net Total : -</td>");
                    rpt.AppendFormat("<td  style='width: 8%;border-top: 1px solid black;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#F6B2B2; font-size:small; text-align:right'>{0}</td>", nettot);
                    rpt.Append("</tr >");
                }*/
            ...
            DataSet instrument = thepatientbill.OTInstrumentBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            if (dtinstrument.Rows.Count > 0)
            {
                ...
                rpt.Append("<td style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#9B9C8D; font-size:small; text-align:center'>Unit</td>");
                ...
                for (int i = 0; i < dtinstrument.Rows.Count; i++)
                {
                    ...
                    rpt.AppendFormat("<td style='width: 8%;font-family:Verdana; font-size:small; text-align:center'>{0}</td>", dtinstrument.Rows[i]["Unit"]);
            ...
            DataSet AnesthesiaMedicine = thepatientbill.OTAnesthesiaMedicineBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            DataSet dsAnesthesiaConsumable = thepatientbill.OTAnesthesiaConsumableBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            if (dtAnesthesiaConsumable.Rows.Count > 0)
            {
                ...
                rpt.Append("<tr style='height:25px'>");
                rpt.Append("<td style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#9B9C8D; font-size:small; text-align:left'>Date</td>");
                rpt.Append("<td  colspan='2' style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#9B9C8D; font-size:left; text-align:center'>Item Name</td>");
                rpt.Append("<td style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#9B9C8D; font-size:small; text-align:right'>Quantity</td>");
                rpt.Append("<td style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#9B9C8D; font-size:small; text-align:right'>Rs. / Unit</td>");
                rpt.Append("<td style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#9B9C8D; font-size:small; text-align:right'>Total</td>");
            ...
            DataSet otattendence = thepatientbill.OTAttendenceBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            DataSet ambulance = thepatientbill.AmbulanceBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            if (dtambulaance.Rows.Count > 0)
            {
                ...
                rpt.Append("<td style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#9B9C8D; font-size:small; text-align:center'>Distance</td>");
                rpt.Append("<td style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#9B9C8D; font-size:small; text-align:right'>Charges</td>");
                ...
                for (int i = 0; i < dtambulaance.Rows.Count; i++)
                {
                    ...
                    rpt.AppendFormat("<td style='width: 8%; font-family:Verdana; font-size:small; text-align:center'>{0}</td>", dtambulaance.Rows[i]["Kelometer"]);
            ...
            DataSet otconsumable = thepatientbill.OTConsumableBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            DataSet sisteraya = thepatientbill.SisterAyaBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            DataSet docvisit = thepatientbill.DoctorVisitBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            if (dtdocvisit.Rows.Count > 0)
            {
                ...
                rpt.Append("<td style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#9B9C8D; font-size:small; text-align:center'>No of Visit</td>");
                ...
                {
                    rpt.Append("<tr style='height:20px'>");
                    rpt.AppendFormat("<td style='width: 8%; font-family:Verdana; font-size:small; text-align:left'>Dr. {0}</td>", dtdocvisit.Rows[i]["doc_name"]);
                    ...
                    rpt.AppendFormat("<td style='width: 8%; font-family:Verdana; font-size:small; text-align:center'>{0}</td>", dtdocvisit.Rows[i]["NoofVisit"]);
            ...
            DataSet medicine = thepatientbill.MedicineBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(),DateTime.Now.ToString("yyyy-MM-dd"),cocode);
            ...
            DataSet service = thepatientbill.ServiceBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            DataSet consumable = thepatientbill.ConsumableBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            DataSet ot = thepatientbill.OTRequisitionBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            decimal test_nettot = 0; decimal pathology_advamt = 0;
            DataSet pathology = thepatientbill.pathologybill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            if (dtpathology.Rows.Count > 0)
            {
                ...
                if (dtpathology.Rows.Count > 0)
                {
                    pathology_advamt = Convert.ToDecimal(dtpathology.Rows[0]["AdAmt"]);
                }
                else
                {
                    pathology_advamt = 0;
                }
                test_nettot = Convert.ToDecimal(dttpathology.Rows[0]["TotalBill"]) - Convert.ToDecimal(dtpathology.Rows[0]["AdAmt"]);
                rpt.Append("<tr style='height:25px'>");
                ...
                rpt.Append("</tr >");
                /*if (Convert.ToDecimal(dtpathology.Rows[0]["AdAmt"]) > 0)
                {
                    rpt.Append("<tr style='height:25px'>");
                    rpt.Append("<td colspan='4' style='width: 8%;border-bottom: 1px solid black;border-top: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#F6B2B2; font-size:small; text-align:center'>Advance Paid : -</td>");
                    rpt.AppendFormat("<td    colspan='2' style='width: 8%;border-bottom: 1px solid black;  border-top: 1px solid black;font-family:Verdana;font-weight:bold;background-color:#F6B2B2; font-size:small; text-align:right'>{0}.00</td>", dtpathology.Rows[0]["AdAmt"]);
                    rpt.Append("</tr >");
                    rpt.Append("<tr style='height:25px'>");
                    rpt.Append("<td colspan='4' style='width: 8%;border-bottom: 1px solid black;border-top: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#F6B2B2; font-size:small; text-align:center'>Total : -</td>");
                    rpt.AppendFormat("<td    colspan='2' style='width: 8%;border-bottom: 1px solid black;  border-top: 1px solid black;font-family:Verdana;font-weight:bold;background-color:#F6B2B2; font-size:small; text-align:right'>{0}.00</td>", test_nettot);
                    rpt.Append("</tr >");
                }*/
            ...
            DataSet xray = thepatientbill.xraybill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            DataSet usg = thepatientbill.USGBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            DataSet others = thepatientbill.OthersBill(ds.Tables[0].Rows[0]["LedgerId"].ToString(), cocode);
            ...
            DataSet total = thepatientbill.QuickTotalBillDtls(txtreg.Text, ds.Tables[0].Rows[0]["LedgerId"].ToString(), DateTime.Now.ToString("yyyy-MM-dd"), cocode);
            DataTable dttotal = total.Tables[1];
            DataTable adv = total.Tables[2];
            rpt.Append("<tr style='height:25px;'>");
            rpt.Append("<td colspan='4' style='width: 8%;border-bottom: 1px solid black;font-family:Verdana;font-weight:bold;background-color:;color:; font-size:small; text-align:left'>Net Total : -</td>");
            //rpt.AppendFormat("<td  colspan='2' style='width: 8%; font-family:Verdana;font-weight:bold;background-color:#6FD5B7;color:#fff;  font-size:small; text-align:center'>{0}.00</td>", Convert.ToDecimal(dttotal.Rows[0]["Total"]) - (Convert.ToDecimal(dtpathology.Rows[0]["AdAmt"]) + Convert.ToDecimal(dtbill.Rows[0]["advamount"])));
            rpt.AppendFormat("<td  colspan='2' style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:;color:;  font-size:small; text-align:right'>{0}.00</td>", dttotal.Rows[0]["Total"]);
            rpt.Append("</tr >");
            rpt.Append("<tr style='height:25px;'>");
            rpt.Append("<td colspan='4' style='width: 8%;border-bottom: 1px solid black;font-family:Verdana;font-weight:bold;background-color:;color:; font-size:small; text-align:left'>Advance Paid on time of Admission : -</td>");
            //rpt.AppendFormat("<td  colspan='2' style='width: 8%; font-family:Verdana;font-weight:bold;background-color:#6FD5B7;color:#fff;  font-size:small; text-align:center'>{0}.00</td>", Convert.ToDecimal(dttotal.Rows[0]["Total"]) - (Convert.ToDecimal(dtpathology.Rows[0]["AdAmt"]) + Convert.ToDecimal(dtbill.Rows[0]["advamount"])));
            rpt.AppendFormat("<td  colspan='2' style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:;color:;  font-size:small; text-align:right'>{0}</td>", dtbill.Rows[0]["advamount"]);
            rpt.Append("</tr >");
            rpt.Append("<tr style='height:25px;'>");
            rpt.Append("<td colspan='4' style='width: 8%;border-bottom: 1px solid black;font-family:Verdana;font-weight:bold;background-color:;color:; font-size:small; text-align:left'>Advance for Pathology/USG/Xray : -</td>");
            //rpt.AppendFormat("<td  colspan='2' style='width: 8%; font-family:Verdana;font-weight:bold;background-color:#6FD5B7;color:#fff;  font-size:small; text-align:center'>{0}.00</td>", Convert.ToDecimal(dttotal.Rows[0]["Total"]) - (Convert.ToDecimal(dtpathology.Rows[0]["AdAmt"]) + Convert.ToDecimal(dtbill.Rows[0]["advamount"])));
            rpt.AppendFormat("<td  colspan='2' style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:;color:;  font-size:small; text-align:right'>{0}</td>", pathology_advamt);
            rpt.Append("</tr >");
            rpt.Append("<tr style='height:25px;'>");
            rpt.Append("<td colspan='4' style='width: 8%;border-bottom: 1px solid black;font-family:Verdana;font-weight:bold;background-color:;color:; font-size:small; text-align:left'>Other Advance : -</td>");
            //rpt.AppendFormat("<td  colspan='2' style='width: 8%; font-family:Verdana;font-weight:bold;background-color:#6FD5B7;color:#fff;  font-size:small; text-align:center'>{0}.00</td>", Convert.ToDecimal(dttotal.Rows[0]["Total"]) - (Convert.ToDecimal(dtpathology.Rows[0]["AdAmt"]) + Convert.ToDecimal(dtbill.Rows[0]["advamount"])));
            rpt.AppendFormat("<td  colspan='2' style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:;color:;  font-size:small; text-align:right'>{0}</td>", Convert.ToDecimal(adv.Rows[0]["advamt"]) - (Convert.ToDecimal(dtbill.Rows[0]["advamount"]) + Convert.ToDecimal(pathology_advamt)));
            rpt.Append("</tr >");
            rpt.Append("<tr style='height:25px'>");
            rpt.Append("<td colspan='4' style='width: 8%;font-family:Verdana;font-weight:bold;background-color:#6FD5B7;color:#fff; font-size:small; text-align:left'>Grand Total(Net Payble) : -</td>");
            //rpt.AppendFormat("<td  colspan='2' style='width: 8%; font-family:Verdana;font-weight:bold;background-color:#6FD5B7;color:#fff;  font-size:small; text-align:center'>{0}.00</td>", Convert.ToDecimal(dttotal.Rows[0]["Total"]) - (Convert.ToDecimal(dtpathology.Rows[0]["AdAmt"]) + Convert.ToDecimal(dtbill.Rows[0]["advamount"])));
            rpt.AppendFormat("<td  colspan='2' style='width: 8%; font-family:Verdana;font-weight:bold;background-color:#6FD5B7;color:#fff;  font-size:small; text-align:right'>{0}.00</td>", Convert.ToDecimal(dttotal.Rows[0]["Total"]) - Convert.ToDecimal(adv.Rows[0]["advamt"]));
            rpt.Append("</tr >");
