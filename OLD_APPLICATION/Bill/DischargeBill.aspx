<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="DischargeBill.aspx.cs" Inherits="Bill_DischargeBill" %>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Discharge Bill</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
           ...
           <td>  <label><strong>Reg No :</strong></label> </td>
           <td>  
           ...
           <td> <asp:Button ID="Button3" runat="server" Text="Search"  CssClass="submit-button" Height="27px" Width="65px" OnClientClick="ShowDialog()"/></td>
                        ...
                        <td>  
                            <asp:Button ID="Button4" runat="server" Height="27px" Text="Get Report" 
                                CssClass="submit-generate" onclick="Button4_Click" Width="95px"  /></td>
         ...
         <asp:HiddenField ID="HiddenField1" runat="server" />
                    ...
                    <tr>
                      ...
                      <asp:Button ID="btnPDF" runat="server"  style="width:70px; font-size:x-small" Text="PDF" onclick="btnPDF_Click"/>    
                           <asp:Button ID="passJV" runat="server" onclick="passJV_Click" Text="Pass Final Bill Journal" Visible="false"  style="width:120px; font-size:x-small"/> 
 </td>
                    </tr>
            </table>
    </ContentTemplate>
