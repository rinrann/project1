<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="InstrumentRepairReceive.aspx.cs" Inherits="IPD_InstrumentRepairReceive" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server"> Instrument Repair Receive</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
    ...
    <td>  <label><strong>Instrument Type :</strong></label> </td>
         ...
         <td>  <label><strong>Instrument Name :</strong></label> </td>
           ...
           <td> <asp:Button ID="Button3" runat="server" Text="Search"  
                   CssClass="submit-button" onclick="Button3_Click" /></td>
