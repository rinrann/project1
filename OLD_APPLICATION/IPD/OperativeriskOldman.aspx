<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="OperativeriskOldman.aspx.cs" Inherits="IPD_OperativeriskOldman" %>
...
<asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Operaive Risk of Old Woman</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
