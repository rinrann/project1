<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="NeonatalHighFeverReport.aspx.cs" Inherits="IPD_NeonatalHighFeverReport" %>
...
<%-- <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Neonatal High Fever</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
           ...
           <td>  <asp:TextBox ID="TextBox1" CssClass="textbox-medium1"  runat="server" Width="150px"></asp:TextBox></td>
