<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="SickCertificate.aspx.cs" Inherits="IPD_SickCertificate" %>
...
<script type="text/javascript" language="javascript">
    ...
    function Calling() {
        $("input[id$='Button4']").click(function () {
            if ($("input[id$='TextBox11']").val() == '') {
                alert('Please Select A Patient !');
                $("input[id$='TextBox11']").focus();
                $("input[id$='TextBox11']").addClass('textboxerr');
                return false;
            }
            else {
                $("input[id$='TextBox11']").removeClass('textboxerr');
            }
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Sick Certificate</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
