...
public partial class IPD_InsrtumentRepairReport : System.Web.UI.Page
{
    ...
    {
        Page.Title = "Instrument Repair";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "INSTRUMENT REPAIR", checkAccessType.ViewAction) == false)
        {
    ...
    {
        ltrReport.Text = "";
        DataTable dt = thepd.GetAllInstrumentRepair(DropDownList1.SelectedValue, DropDownList2.SelectedValue, TextBox1.Text.Trim(), Session["CoCode"].ToString().Trim());
        if (dt.Rows.Count > 0)
        {
            rpt.Append("<br/>");
            ...
            rpt.Append("<td colspan='4' style='width: 8%;border-bottom: 1px solid black; font-family:Verdana;font-weight:bold;background-color:#9B9C8D;font-size:medium; text-align:Center'> Instrument Repair Details </td>");
            rpt.Append("</tr'>");
            ...
            rpt.Append("<td style='width: 8%;border-bottom: 1px solid black;border-right: 1px solid black; font-family:Verdana;font-weight:bold;background-color:beige; font-size:small; text-align:Center'>Repair Date</td>");
            rpt.Append("<td style='width: 8%;border-bottom: 1px solid black;border-right: 1px solid black; font-family:Verdana;font-weight:bold;background-color:beige; font-size:small; text-align:Center'>Repair Cost</td>");
            rpt.Append("</tr >");
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                rpt.AppendFormat("<td style='width: 5%;border-bottom: 1px solid black;border-right: 1px solid black; font-family:Verdana; font-size:small;text-align:Center'>{0}</td>", dt.Rows[i]["RepairDate"]);
                rpt.AppendFormat("<td style='width: 5%;border-bottom: 1px solid black;border-right: 1px solid black; font-family:Verdana; font-size:small;text-align:Center'>{0}</td>", dt.Rows[i]["RepairCost"]);
                rpt.Append("</tr >");
            }
    ...
    {
        DropDownList2.DataSource = thepd.DropdownInstrumentName("1", Session["CoCode"].ToString().Trim());
