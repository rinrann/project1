<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IpdpatientInstrumentPopup.aspx.cs" Inherits="IPD_IpdpatientInstrumentPopup" %>
  ...
  margin-right:auto; 
    ...
    <script type="text/javascript" >
        ...
        function CloseDialog() {
            ...
            window.opener.document.getElementById("ctl00_ContentPlaceHolder1_TextBox46").value = arg.NameValue;
            window.close();
        }
