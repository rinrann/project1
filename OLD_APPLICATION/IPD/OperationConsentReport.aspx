<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="OperationConsentReport.aspx.cs" Inherits="IPD_OperationConsentReport" %>
...
<asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Operation Consent</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
           ...
           <td>  <asp:TextBox ID="txtreg" CssClass="textbox-medium1"  runat="server" Width="150px"></asp:TextBox></td>
