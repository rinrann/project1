...
public partial class IPD_RecallPatientPopup : System.Web.UI.Page
{
    RecallPopupClass thereg = new RecallPopupClass(ConfigurationSettings.AppSettings["ConnectionString"].ToString());
