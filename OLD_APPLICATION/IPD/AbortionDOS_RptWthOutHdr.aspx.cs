...
public partial class IPD_AbortionDOS_RptWthOutHdr : System.Web.UI.Page
{
    ...
    public void GenerateReport()
    {
        ...
        if (RptDt != null)
        {
            if (RptDt.Rows.Count > 0)
            {
                ...
                Path = Server.MapPath("Print/AbortionDos_RptWthOutHDr.txt");
                ...
                string filePath = "AbortionDos_RptWthOutHDr.txt";
