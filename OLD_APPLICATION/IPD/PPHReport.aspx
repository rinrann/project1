<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="PPHReport.aspx.cs" Inherits="IPD_PPHReport" %>
...
<asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">PPH</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
