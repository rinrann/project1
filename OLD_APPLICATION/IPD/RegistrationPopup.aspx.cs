...
public partial class Pathology_RegistrationPopup : System.Web.UI.Page
{
    ...
    {
        GridView1.DataSource = thereg.GridPopup1(txtreg.Text.Trim(), txtname.Text.Trim(), txtph.Text.Trim(), txtaddress.Text.Trim(), Session["CoCode"].ToString().Trim(), Session["YearCode"].ToString().Trim());
        GridView1.DataBind();
    }
