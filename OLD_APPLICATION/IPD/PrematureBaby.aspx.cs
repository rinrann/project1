...
public partial class IPD_PrematureBaby : System.Web.UI.Page
{
    ...
    {
        Page.Title = "Premature Baby";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "PREMATURE BABY", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>অপরিনত বাচ্চা, অস্বাভাবিক কম ওজন, জীবনী শক্তি কম, ফুসফুস কমজোরী, হার্ট দূর্বল, অন্যান্য অঙ্গ অপরিনত, খাওয়ানোর সমস্যা, যখন তখন বাচ্চার অবস্থা খারাপ হওয়ার প্রনণতা</td>");
            rpt.Append("</tr >");
            ...
            rpt.Append("<tr style='height:35px'>");
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>ইনফেকসন বা সেপশিস হতে পারে, শ্বাসকষ্ট হতে পারে, হঠাৎ হৃদযন্র বিকল হতে পারে, পেট ফুলে যেতে পারে, যখন তখন বাচ্চার অবস্থা খারাপ হতে পারে, এমন কি মারা ও যেতে পারে, যে কোন মুহূর্তে অন্যত্র নিয়ে যেতে হতে পারে</td>");
            rpt.Append("</tr >");
            rpt.Append("</table>");
            rpt.Append("<br/>");
            rpt.Append("<table width='100%'>");
    ...
    public void PDF()
    {
        string filename = "PrematureBaby" + TextBox1.Text;
