...
public partial class IPD_BroChopReport : System.Web.UI.Page
{
    ...
    {
        Page.Title = "NeoNatal Brochop Neumonia";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "NEONATAL BROCHOPNEUMONIA", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>বুকে সর্দি বসে গেছে, জ্বর, মুমূর্ষূ বাচ্চা, প্রচন্ড শ্বাসকষ্ট, শুয়ে থাকতে পারছে না খেতে পারছে না,জীবনী শক্তি কম, ফুসফুস কমজোরী, হার্ট দূর্বল</td>");
            rpt.Append("</tr >");
            ...
            rpt.Append("<tr style='height:35px'>");
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'> ইনফেকসন বা সেপশিস হতে পারে, শ্বাসকষ্ট আরও বাড়তে পারে, হঠাৎ হৃদযন্র বিকল হতে পারে, পেট ফুলে যেতে পারে, যখন তখন বাচ্চার অবস্থা আরও খারাপ হতে পারে, এমন কি মারা ও যেতে পারে, যে কোন মুহূর্তে অন্যত্র নিয়ে যেতে হতে পারে  </td>");
            rpt.Append("</tr >");
            rpt.Append("</table>");
            rpt.Append("<br/>");
            rpt.Append("<table width='100%'>");
 ...
 DataTable dt = theJaundice.GetPatientDtls(TextBox1.Text, Session["CoCode"].ToString().Trim());
    ...
    public void PDF()
    {
        string filename = "NeoNatalBrochopNeumonia" + TextBox1.Text;
