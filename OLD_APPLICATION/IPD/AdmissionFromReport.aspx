<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="AdmissionFromReport.aspx.cs" Inherits="IPD_AdmissionFromReport" %>
 ...
 <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Admission Form</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
