...
public partial class IPD_APHReport : System.Web.UI.Page
{
    Main Objmain = new Main(ConfigurationSettings.AppSettings["ConnectionString"].ToString());
    APHReport theaph = new APHReport(ConfigurationSettings.AppSettings["ConnectionString"].ToString());
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "APH", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
          ...
          DataTable dt = theaph.GetPatientDtls(TextBox1.Text, Session["CoCode"].ToString().Trim());
        if (dt.Rows.Count > 0)
        {
            rpt.Append("<br/>");
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'> ফুল নিচের দিকে আছে এবং যে কোন সময়ে প্রচন্ড রক্তস্রাবের সম্ভাবনা, ডেলিভারীর এখনো অনেক দেরী তাই বাচ্চা অপরিনত, যদি ওষুধে ব্লিডিং বন্ধ না হয় বাচ্চা বাঁচবে না জেনে ও সীজার করতে হতে পারে মাকে বাঁচানোর জন্যে,এখুনি প্রচুর রক্ত লাগবে, এই রক্ত জোগাড় করার দায়িত্ব রোগীর বাড়ীর লোককেই নিতে হবে, রক্ত জোগাড় করতে যত দেরি হবে রোগীর বিপদ তত বাড়বে </td>");
            rpt.Append("</tr >");
            ...
            rpt.Append("<tr style='height:35px'>");
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'> প্রচন্ড রক্তস্রাবের জন্য শরীর রক্তশূণ্য হয়ে যেতে পারে, হঠাৎ রোগীর হৃদ স্পন্দন থেমে যেতে পারে, রোগী মারা যেতে পারে, বাচ্চাও মারা যেতে পারে, ফুসফুস কিডনি লিভার বিকল হতে পারে, যে কোন মুহূর্তে রোগীকে অন্যত্র নিয়ে যেতে হতে পারে, বাচ্চা অপরিনত ও দূর্বল হতে পারে এবং মারাও যেতে পারে, খুব বিরল ক্ষেত্রে রোগীর জীবনের স্বার্থে জরায়ূ কেটে বাদ দিতে হতে পারে, এই রোগের চিকিৎসার কোন গ্যারান্টী নেই </td>");
            rpt.Append("</tr >");
            rpt.Append("</table>");
            rpt.Append("<br/>");
            rpt.Append("<table width='100%'>");
    ...
    public void PDF()
    {
        string filename = "APH" + TextBox1.Text;
