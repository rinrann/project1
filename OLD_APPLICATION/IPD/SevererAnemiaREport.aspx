<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="SevererAnemiaREport.aspx.cs" Inherits="IPD_SevererAnemiaREport" %>
...
<%--<asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Severer Anemia</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
