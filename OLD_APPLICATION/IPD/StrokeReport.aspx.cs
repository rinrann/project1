...
public partial class IPD_StrokeReport : System.Web.UI.Page
{
    Main Objmain = new Main(ConfigurationSettings.AppSettings["ConnectionString"].ToString());
    Eclamsia12 thestroke = new Eclamsia12(ConfigurationSettings.AppSettings["ConnectionString"].ToString());
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "STROKE", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
         ...
         DataTable dt = thestroke.GetPatientDtls(TextBox1.Text, Session["CoCode"].ToString().Trim());
        if (dt.Rows.Count > 0)
        {
            rpt.Append("<br/>");
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>ব্রেনে রক্তপাত, অজ্ঞান অবস্থা, প্যারালেসিস, জীবনী শক্তি কম, ফুসফুস কমজোরী, হার্ট দূর্বল এবং অনিয়মিত, অন্যান্য অঙ্গ ভাল কাজ করছে না</td>");
            rpt.Append("</tr >");
            ...
            rpt.Append("<tr style='height:35px'>");
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>আর জ্ঞান না ফিরতে পারে, প্যারালেসিস হতে পারে, শ্বাসকষ্ট হতে পারে, ব্রেনে আরও রক্তপাত হতে পারে, হঠাৎ হৃদযন্র বিকল হতে পারে, পেট ফুলে যেতে পারে,ইনফেকসন বা সেপশিস হতে পারে, যখন তখন রোগীর অবস্থা আরও খারাপ হতে পারে, এমন কি মারা ও যেতে পারে, যে কোন মুহূর্তে অন্যত্র নিয়ে যেতে হতে পারে,এই রোগের চিকিৎসার কোন গ্যারান্টী নেই</td>");
            rpt.Append("</tr >");
            rpt.Append("</table>");
            rpt.Append("<br/>");
            rpt.Append("<table width='100%'>");
    ...
    public void PDF()
    {
        string filename = "Stroke" + TextBox1.Text;
