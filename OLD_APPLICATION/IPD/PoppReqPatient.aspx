<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PoppReqPatient.aspx.cs" Inherits="IPD_PoppReqPatient" %>
...
<td>
             ...
             <tr align="center">                       
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Bed No">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblph1" runat="server" Text='<%# Bind("BedNoText") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Diagnosis">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblph2" runat="server" Text='<%# Bind("DiagnosisName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <tr>
            ...
            <td align="right"><input id="btnClose" type="button" class="submit-button1" value="Ok" style='width:75px; height:30px;'  onclick="CloseDialog();" /></td>
            <td align="left">                
             <input id="Button1" type="button" value="Cancel" class="submit-button1" style='width:75px; height:30px;' onclick="return Button1_onclick()"" /> 
