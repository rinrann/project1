<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="InstrumentPurchaseReport.aspx.cs" Inherits="IPD_InstrumentPurchaseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Instrument Purchase</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
