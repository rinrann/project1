<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="OTInstrumentReject.aspx.cs" Inherits="IPD_OTInstrumentReject" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="pageheader">
                <asp:Label ID="Label1" runat="server">OT Instrument Reject</asp:Label>
            </div>
                ...
                <div class="clear">
                    ...
                    <div class="form-sec-row">
                       ...
                       <div class="form-sec-row">
                        <label>
                        <strong>
                        Reason of Rejection :</strong></label>
                    ...
                    <table width="100%">
                    <tr>
                          <td><label><strong>Instrument Type :</strong></label></td>
                      <td> 
                          <asp:DropDownList ID="DropDownList5" Width="150px" runat="server" 
        ...
        <div class="listing"  style='width:100%; height:300px; overflow:auto;'>
               ...
               <asp:TemplateField HeaderText="Instrument Type id" Visible="false">
                        ...
                        <asp:TemplateField HeaderText="Rejection Reason">
                            <ItemTemplate>
                                <asp:Label ID="RejectReason" runat="server" Text='<%# Bind("RejectReason") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
