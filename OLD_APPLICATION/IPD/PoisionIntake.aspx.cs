...
public partial class IPD_PoisionIntake : System.Web.UI.Page
{
    ...
    {
        Page.Title = "Poision Intake";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "POISION INTAKE", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>বিষক্রিয়ায় হার্ট ফুসফুস কিডনি লিভার ও ব্রেন বিকল হতে পারে, ইনফেকসন বা সেপশিস হতে পারে, শ্বাসকষ্ট হতে পারে, ব্রেনে রক্তপাত হতে পারে, হঠাৎ হৃদযন্র বিকল হতে পারে, পেট ফুলে যেতে পারে, যেখানে সেখানে রক্তপাত হতে পারে</td>");
            rpt.Append("</tr >");
            ...
            rpt.Append("<tr style='height:35px'>");
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'> যখন তখন রোগীর অবস্থা আরও খারাপ হতে পারে, এমন কি মারা ও যেতে পারে, যে কোন মুহূর্তে অন্যত্র নিয়ে যেতে হতে পারে, দীর্ঘ মেয়াদী বিষের কুফল শরীরকে পঙ্গু করে দিতে পারে,এই রোগের চিকিৎসার কোন গ্যারান্টী নেই</td>");
            rpt.Append("</tr >");
            rpt.Append("</table>");
            rpt.Append("<br/>");
            rpt.Append("<table width='100%'>");
    ...
    public void PDF()
    {
        string filename = "PoisionIntake" + TextBox1.Text;
