<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="PostOprative.aspx.cs" Inherits="IPD_PostOprative" %>
...
<asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Post Operative</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
