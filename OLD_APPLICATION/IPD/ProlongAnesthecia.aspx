<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="ProlongAnesthecia.aspx.cs" Inherits="IPD_ProlongAnesthecia" %>
...
<asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Prolong Anesthesia</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
