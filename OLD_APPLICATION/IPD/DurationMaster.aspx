<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="DurationMaster.aspx.cs" Inherits="IPD_DurationMaster" %>
      ...
      function Calling() {
          $("input[id$='Button1']").click(function () {
              if ($("input[id$='txtchemicalname']").val() == '') {
                  alert('Please Enter Duration Name !');
...
<%--For Busy Loader .............................--%>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Duration Master</asp:Label>
     </div>
     ...
     <asp:HiddenField ID="HiddenField1" runat="server" />
			<div class="form-sec-row">
                <label><strong>Duration in Day's :</strong></label>
  ...
  <tr style='border:1px solid black;'> 
   <td style='width:150px;' align="center">Duration Name</td> 
     ...
     <div class="listing"   style='width:100%; height:500px; overflow:auto;'>
         <asp:GridView id="GridView1"  CssClass="grid"
                 PagerStyle-CssClass="pgr" DataKeyNames ="DurationId" runat="server"  ShowHeader="false"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Id" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="lblID" runat="server" Text='<%# Bind("DurationId") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="DOSE NAME "     ItemStyle-Width="150px">
                       
                        <ItemTemplate>
                            <asp:Label ID="lblname" runat="server" Text='<%# Bind("DurationName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
