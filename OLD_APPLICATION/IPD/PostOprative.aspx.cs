...
public partial class IPD_PostOprative : System.Web.UI.Page
{
    ...
    {
        Page.Title = "Post Operative";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "POST OPERATIVE COMPLICATION", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>  ব্লীডিং হচ্ছে, পেট ফুলে আছে, বায়ূ সরছে না, জ্বর কমছে না, কাটা জায়গায় ঘা, জন্ডিস </td>");
            rpt.Append("</tr >");
    ...
    public void PDF()
    {
        string filename = "Post Operative" + TextBox1.Text;
