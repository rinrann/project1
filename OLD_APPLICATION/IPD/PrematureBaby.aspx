<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="PrematureBaby.aspx.cs" Inherits="IPD_PrematureBaby" %>
...
<asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Premature Baby</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
