...
public partial class IPD_PPHReport : System.Web.UI.Page
{
    Main Objmain = new Main(ConfigurationSettings.AppSettings["ConnectionString"].ToString());
    Eclamsia12 pph = new Eclamsia12(ConfigurationSettings.AppSettings["ConnectionString"].ToString());
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "PPH", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
         ...
         DataTable dt = pph.GetPatientDtls(TextBox1.Text, Session["CoCode"].ToString().Trim());
        if (dt.Rows.Count > 0)
        {
            rpt.Append("<br/>");
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>প্রসবের পর প্রচুর রক্তস্রাব হচ্ছে, কার এই রোগ হবে তা আগে থেকে জানা বা আগে থেকে কোন প্রতিষেধক নেওয়া যায় না, প্রচুর রক্তস্রাবের জন্য রোগী রক্তশূণ্য হতে পারে,হঠাৎ রোগীর হৃদ স্পন্দন থেমে যেতে পারে, রোগী মারা যেতে পারে, ফুসফুস, কিডনি, লিভার বিকল হতে পারে, যে কোন মুহূর্তে রোগীকে অন্যত্র নিয়ে যেতে হতে পারে, এই রোগের চিকিৎসার কোন গ্যারান্টী নেই</td>");
            rpt.Append("</tr >");
            ...
            rpt.Append("<tr style='height:35px'>");
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>এখুনি প্রচুর রক্ত লাগবে, এই রক্ত জোগাড় করার দায়িত্ব রোগীর বাড়ীর লোককেই নিতে হবে, রক্ত জোগাড় করতে যত দেরি হবে রোগীর বিপদ তত বাড়বে, আর রক্ত না পেলে চিকিৎসা করা প্রায় অসম্ভব, রক্ত পাত বন্ধ না হলে অপারেশন করে জরায়ূ কেটে বাদ দিতে হবে ও এরপর রোগীর আর কোনদিন বাচ্চা হবে না আর মাসিক ও হবে না</td>");
            rpt.Append("</tr >");
            rpt.Append("</table>");
            rpt.Append("<br/>");
            rpt.Append("<table width='100%'>");
    ...
    public void PDF()
    {
        string filename = "PPH" + TextBox1.Text;
