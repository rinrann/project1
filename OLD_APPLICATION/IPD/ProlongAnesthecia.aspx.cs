...
public partial class IPD_ProlongAnesthecia : System.Web.UI.Page
{
    ...
    {
        Page.Title = "Prolong Anesthesis";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "PROLONG ANESTHESIA", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'> অপারেশনের পর রোগীর জ্ঞান ফিরছে না, কোন রোগীর এই অবস্থা ঘটবে তা আগে থেকে জানা বা বোঝা সম্ভব নয় তাই প্রতিষেধক নেওয়াও অসম্ভব,ডাঃবাবুরা প্রাণপণ চেষ্টা চালাচ্ছেন কিন্তু পরিশেষে কি হবে বলা যাবে না, এখন যন্ত্রের সাহায্যে শ্বাস প্রশ্বাস চালানো হচ্ছে এবং এই মূহূর্তে অন্য জায়গায় স্থানান্তরিত করাও মুশকিল</td>");
            rpt.Append("</tr >");
    ...
    public void PDF()
    {
        string filename = "ProlongAnesthesis" + TextBox1.Text;
