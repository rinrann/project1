<%@ Page Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="ImplantMaster.aspx.cs" Inherits="Master_ImplantMaster" %>
...
<script language="javascript" type="text/javascript">
    ...
    function autoCompleteEx_ItemSelected(sender, args) {
        ...
        document.getElementById("ctl00_ContentPlaceHolder1_txtDescription").value = regname[0];
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="pageheader">
                <asp:Label ID="Label1" runat="server">Implant Master</asp:Label>
            </div>
         ...
         <tr>
             ...
             <asp:MultiView ID="MainView" runat="server">
                ...
                <div class="form-sec">
                    ...
                    <div class="form-sec-row">
                        <label><strong>
                        Implant Description :</strong></label>
                        <asp:TextBox ID="txtDescription" runat="server" CssClass="textbox-medium1" ></asp:TextBox>
                        <cc1:AutoCompleteExtender ServiceMethod="Searchimplant" OnClientItemSelected="autoCompleteEx_ItemSelected" MinimumPrefixLength="1"
                                    CompletionInterval="100" EnableCaching="false" CompletionSetCount="10" TargetControlID="txtDescription" ID="AutoCompleteExtender2" runat="server" 
            ...
            <div class="listing"  style='width:100%; height:400px; overflow:auto;'>
                <asp:GridView id="GridView1"  Width="100%" CssClass="grid" PagerStyle-CssClass="pgr"
                 DataKeyNames ="ImplantID" runat="server" 
                 ...
                 OnPageIndexChanging="GridView1_PageIndexChanging" SelectedRowStyle-BackColor="GreenYellow">
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Implant ID" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="ImplantID" runat="server" Text='<%# Bind("ImplantID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Implant Description">
                            <ItemTemplate>
