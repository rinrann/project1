...
public partial class IPD_FitCertificate : System.Web.UI.Page
{
    ...
    {
        Page.Title = "FitCertificate";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "FIT CERTIFICATE", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt.Append("<tr style='height:35px'>");
            rpt.AppendFormat("<td style='font-family:Arial;font-size:small; text-align:justify'>Mr/Mrs {0} was under my treatment at <b>GFC</b>, Kushpata, Ghatal, Paschim Medinipur.</td>", dt.Rows[0]["patient_name"]);
            rpt.Append("</tr >");

            rpt.Append("<tr style='height:35px'>");
            rpt.Append("<td style='font-family:Arial;font-size:small; text-align:justify'>He / She is now fit for resuming his / her normal duties.</td>");
            rpt.Append("</tr >");
            ...
            rpt.Append("<table width='100%' cellspacing=0 border=0 style=' border-spacing: 0; padding: 0;font-family:verdana;'>");
            rpt.Append("<tr>");
            rpt.Append("<td style='font-family:Arial;font-size:medium;  text-align:left'> .............................................................   </td>");
            rpt.Append("</tr>");
            rpt.Append("<tr>");
            rpt.Append("<td style='font-family:Arial;font-size:medium; font-weight:bold;text-align:left'> His / Her signature is attested by me  </td>");
            rpt.Append("</tr>");
            rpt.Append("</table>");
    ...
    public void PDF()
    {
        string filename = "FitCertificate" + TextBox11.Text;
