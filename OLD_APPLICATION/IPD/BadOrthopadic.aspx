<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="BadOrthopadic.aspx.cs" Inherits="IPD_BadOrthopadic" %>
   ...
   <script type="text/javascript" language="javascript">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Bad Orthopadic</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
