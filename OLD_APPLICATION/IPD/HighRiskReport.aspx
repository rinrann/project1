<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="HighRiskReport.aspx.cs" Inherits="IPD_HighRiskReport" %>
...
<%-- <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Heart Patient</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
           ...
           <td>  <asp:TextBox ID="TextBox1" CssClass="textbox-medium1"  runat="server" 
                   Width="150px" EnableViewState="False"></asp:TextBox></td>
