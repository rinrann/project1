...
public partial class IPD_NeoNatalphysia : System.Web.UI.Page
{
    ...
    {
        Page.Title = "Neonatal Ashyxia";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "NEONATAL ASPHYXIA", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>ব্রেনে অক্সিজেন কম হওয়ায় ব্রেন ড্যামেজ, ব্রেনে রক্তপাত , ইনফেকসন বা সেপশিস , প্রচন্ড শ্বাসকষ্ট, খিঁচুনি</td>");
            rpt.Append("</tr >");
    ...
    public void PDF()
    {
        string filename = "Neonatal Ashyxia" + TextBox1.Text;
