<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterAll/MasterPageAll.master"  CodeFile="CommissionReport.aspx.cs" Inherits="IPD_CommissionReport" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Comission Details</asp:Label>
        </div>
