...
public partial class IPD_OperationTemplate : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Page.Title = "Operation & Cons Template";
    ...
    public void OperationFillMap(string id)
    {
        DataTable dt = new DataTable();
        DataRow row = dt.NewRow();
        ...
        DataTable dtfill = theshift.OperationFillMap(id);
        if (dtfill.Rows.Count > 0)
        {
            for (int i = 0; i < dtfill.Rows.Count; i++)
            {
    ...
    public int InsertMapping()
    {
        ...
        for (int i = 0; i < GridView8.Rows.Count; i++)
        {
            ...
            if (theshift.OperationTemplateFillFunction(1, ddlSelOprn.SelectedValue, txtTemplateName.Text.Trim(), lblConGrId.Text, lblConItemID.Text, lblActualQty.Text, lblBillQty.Text, lblPrice.Text) == true)
            {
                flag = 1;
            }
            else
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //    id = "0";
        //}
        id = ddlSelOprn.SelectedValue;
        if (Button1.Text == "Submit")
        {
            //dibynedu
            //vivek
            if (theshift.OperationTempSave(1, id, id, txtTemplateName.Text, Session["userName"].ToString(), DateTime.Now.ToString("MM/dd/yyyy"), txtserviceCharge.Text, Session["CoCode"].ToString()) == true)
            {
                flag = InsertMapping();
            }
            if (flag == 1)
        ...
        else
        {
            //dibyendu
            //vivek
            if (theshift.OperationTempSave(2, id, id, txtTemplateName.Text, Session["userName"].ToString(), DateTime.Now.ToString("MM/dd/yyyy"), txtserviceCharge.Text, Session["CoCode"].ToString()) == true)
            {
                theshift.OperationTemplateFillFunction(2, id, null, null, null, null, null, null);
                flag = InsertMapping();
            }
    ...
    private void DropDownFill()
    {
        ...
        ddlSelOprn.DataSource = theshift.OperationNames();
        ddlSelOprn.DataValueField = "OperationID";
        ddlSelOprn.DataTextField = "OperationName";
        ddlSelOprn.DataBind();
        ddlSelOprn.Items.Insert(0, new ListItem("--Select--", "0"));
        for (int i = 1; i <= 1; i++)
        {
    ...
    private void GridFill()
    {
        ...
        GridView1.DataSource = theshift.OperationGridFillName();
        GridView1.DataBind();
    }
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Select")
        {
            ...
            ddlSelOprn.SelectedValue = TemplateCategoryId.Text;
            ...
            OperationFillMap(TemplateCategoryId.Text);
            Tab1Func();
            Button1.Text = "Update";
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        if (theshift.OperationTempSave(3, NameID.Text, null, null, null, null, null, Session["CoCode"].ToString()) == true)
        {
