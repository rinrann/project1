<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="DischargeCertificateProvesional.aspx.cs" Inherits="IPD_DischargeCertificateProvesional" %>
...
<asp:UpdateProgress ID="UpdateProgress1" runat="server">
    <ProgressTemplate>    
       <div id="aaa" class="progressBackgroundFilter">
       </div>
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Provesional Discharge Certificate</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
