...
public partial class IPD_OperativeriskOldman : System.Web.UI.Page
{
    ...
    {
        Page.Title = "Operaive Risk of Old Woman";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "OPERATIVE RISK IN OLD WOMAN", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>অনিয়মিত হৃদস্পন্দন, অনিয়ন্ত্রিত ব্লাড প্রেসার, সুগারের ও বেশী বয়সের সমস্যা, জরায়ুতে দুরারোগ্য ঘা, মানসিক সমস্যা, অসহিষ্ণু রোগী।</td>");
            rpt.Append("</tr >");
    ...
    public void PDF()
    {
        string filename = "OperaiveRiskofOldWoman" + TextBox1.Text;
