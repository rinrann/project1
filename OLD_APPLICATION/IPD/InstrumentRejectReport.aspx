<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="InstrumentRejectReport.aspx.cs" Inherits="IPD_InstrumentRejectReport" %>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server"> Instrument Reject</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
