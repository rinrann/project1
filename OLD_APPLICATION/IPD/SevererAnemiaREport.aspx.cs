...
public partial class IPD_SevererAnemiaREport : System.Web.UI.Page
{
    ...
    {
        Page.Title = "Severer Anemia";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "SEVERE ANEMIA", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'> রোগীর দেহে রক্ত খুব কম,জীবনী শক্তি কম, ফুসফুস কমজোরী, হার্ট দূর্বল , অন্যান্য অঙ্গ ভাল কাজ করছে না, এত রক্ত রোগীকে দেওয়ার সমস্যা ও কিডনির সমস্যা আসতে পারে</td>");
            rpt.Append("</tr >");
            ...
            rpt.Append("<tr style='height:35px'>");
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'> এখুনি প্রচুর রক্ত লাগবে, এই রক্ত জোগাড় করার দায়িত্ব রোগীর বাড়ীর লোককেই নিতে হবে, রক্ত জোগাড় করতে যত দেরি হবে রোগীর বিপদ তত বাড়বে আর রক্ত না পেলে চিকিৎসা চালিয়ে যাওয়া অসম্ভব, রক্ত কম থাকার জন্য কিডনি ও হার্ট ফেল করতে পারে,আর যদি অপারেশনের দরকার হয় রক্ত না পেলে অপারেশন করা প্রায় অসম্ভব</td>");
            rpt.Append("</tr >");
            rpt.Append("</table>");
            rpt.Append("<br/>");
            rpt.Append("<table width='100%'>");
    ...
    public void PDF()
    {
        string filename = "SevererAnemia" + TextBox1.Text;
