<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="PrescriptionGateWay.aspx.cs" Inherits="OPD_PrescriptionGateWay" %>
...
<script type="text/javascript" language="javascript">
    ...
    function ShowDialog() {
        ...
        //$("#btnGetPrescrip").click();
        //$("#ctl00_ContentPlaceHolder1_btnGetPrescrip").click();
        getPrescriptions();
    }

    function getPrescriptions() {
        var regno = $("#txtreg").val();
        $.ajax({
            type: "POST",
            url: 'PrescriptionGateWay.aspx/getPrescriptions',
            data: "{regno:'"+regno+"'}",
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Prescription</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
           ...
           <td>  <asp:TextBox ID="txtreg" CssClass="textbox-medium1"  runat="server" Width="150px" Enabled="False"  ClientIDMode="Static"></asp:TextBox></td>
           <td> 
               <asp:Button ID="Button3" runat="server" Text="Search"  CssClass="submit-button"  OnClientClick="ShowDialog()" />
