<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="VaccinationMaster.aspx.cs" Inherits="OPD_VaccinationMaster" %>
        ...
        function Calling() {
            ...
            $("input[id$='Button1']").click(function () {
                if ($("input[id$='txtchemicalname']").val() == '') {
                    alert('Please Enter Vaccination Name !');
...
<%--For Busy Loader .............................--%>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Vaccination Master</asp:Label>
     </div>
     ...
     <asp:HiddenField ID="HiddenField1" runat="server" />
			<div class="form-sec-row">
                <label><strong>Vaccination Name :</strong></label>
                 <asp:TextBox ID="txtchemicalname" runat="server" CssClass="textbox-medium1" 
                   ></asp:TextBox>
                <cc1:AutoCompleteExtender ServiceMethod="SearchVac" OnClientItemSelected="autoCompleteEx_ItemSelected" MinimumPrefixLength="1"
