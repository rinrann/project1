<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="PrescriptionGroup.aspx.cs" Inherits="OPD_PrescriptionGroup" %>
...
<%--For Busy Loader .............................--%>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Prescription Group Master</asp:Label>
     </div>
     ...
     <asp:HiddenField ID="HiddenField1" runat="server" />
			<div class="form-sec-row">
                <label><strong>Prescription Group Name :</strong></label>
                 <asp:TextBox ID="txtchemicalname" runat="server" CssClass="textbox-medium1" 
                   ></asp:TextBox>
                <cc1:AutoCompleteExtender ServiceMethod="SearchPresGroup" OnClientItemSelected="autoCompleteEx_ItemSelected" MinimumPrefixLength="1"
     ...
     <div class="listing"   style='width:100%; height:300px; overflow:auto;'>
         <asp:GridView id="GridView1"  CssClass="grid"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Prescription Group">
                       
                        <ItemTemplate>
                            <asp:Label ID="lblname" runat="server" Text='<%# Bind("PrescriptionGroupName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
