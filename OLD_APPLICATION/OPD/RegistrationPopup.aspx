<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistrationPopup.aspx.cs" Inherits="Pathology_RegistrationPopup" %>
  ...
  margin-right:auto; 
    ...
    <script type="text/javascript" >
        ...
        function CloseDialog() {
            ...
            arg.ProfessionValue = document.getElementById('HiddenField3').value;
            window.returnValue = arg;
            window.opener.document.getElementById("ctl00_ContentPlaceHolder1_TextBox2").value = arg.NameValue;
            if (type == "1") {
           ...
           <asp:Button ID="Button2" runat="server" Text="Search" Height="28px"  CssClass="submit-button1" onclick="Button2_Click" 
             ...
             <tr align="center">                       
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Appo NO" Visible="false">
