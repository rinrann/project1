<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PtientAppointmentpopup.aspx.cs" Inherits="OPD_PtientAppointmentpopup" %>
  ...
  margin-right:auto; 
    ...
    <script type="text/javascript" >
        ...
        function CloseDialog() {
            ...
            arg.Appno = document.getElementById('HiddenField3').value;
            arg.AppDate = document.getElementById('HiddenField4').value;
            ...
            window.opener.document.getElementById("ctl00_ContentPlaceHolder1_TextBox1").value = arg.Appno;
            window.opener.document.getElementById("ctl00_ContentPlaceHolder1_txtCheckedDate").value = arg.AppDate;
            window.close();
