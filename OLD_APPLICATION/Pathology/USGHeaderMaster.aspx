<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="USGHeaderMaster.aspx.cs" Inherits="Pathology_USGHeaderMaster" %>
...
<script type="text/javascript" language="javascript">
    ...
    function Calling() {
        $("input[id$='Button1']").click(function () {
            ...
            if ($("input[id$='txtcontent']").val() == '') {
                $("input[id$='txtcontent']").addClass('textboxerr');
            }

            if ($("input[id$='txtcontent']").val() == '') {
                alert('Please Enter Content !');
                $("input[id$='txtcontent']").focus();
                $("input[id$='txtcontent']").addClass('textboxerr');
                return false;
            }
            else {
                $("input[id$='txtcontent']").removeClass('textboxerr');
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">USG Header Master</asp:Label>
     </div>
     ...
     <div class="form-sec">
            ...
            <div class="form-sec-row">
                <label><strong>Header Name :</strong></label>
                <asp:TextBox ID="txtname" runat="server" CssClass="textbox-medium1" 
                   ></asp:TextBox>
                <cc1:AutoCompleteExtender ServiceMethod="SearchUSGHead" OnClientItemSelected="autoCompleteEx_ItemSelected" MinimumPrefixLength="1"
               ...
               <div class="form-sec-row">
                <label><strong>Header Content :</strong></label>
                <asp:TextBox ID="txtcontent" runat="server" CssClass="textbox-mediummul" TextMode="MultiLine" 
                   ></asp:TextBox>
                <div class="clear"></div>
            </div>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Group Name">
                     ...
                     <asp:TemplateField HeaderText="Header Name">
                        <ItemTemplate>
                            <asp:Label ID="lblname" runat="server" Text='<%# Bind("HeaderName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                                           
                        <asp:TemplateField HeaderText="Header Content">
                        <ItemTemplate>
                            <asp:Label ID="lblcontent" runat="server" Text='<%# Bind("HeaderContent") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>                                                 
