<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompanyPopup.aspx.cs" Inherits="Pathology_CompanyPopup" %>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <%--For Busy Loader End.............................--%>
       ...
       <tr>
             ...
             <label class="pname"><strong>Company Name :</strong></label> 
           ...
           <asp:Button ID="Button2" runat="server" Text="Search"  Height="28px" CssClass="submit-button1" onclick="Button2_Click" 
             ...
             <tr align="center">                       
                  ...
                  <asp:GridView id="GridView_popup" CssClass="grid" PagerStyle-CssClass="pgr" DataKeyNames ="CCode" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Company Code">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblregno" runat="server" Text='<%# Bind("CCode") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
