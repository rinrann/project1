<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="SuppilierMaster.aspx.cs" Inherits="Pathology_SuppilierMaster" %>
...
<script language="javascript" type="text/javascript">
    ...
    function autoCompleteEx_ItemSelected(sender, args) {
        ...
        document.getElementById("ctl00_ContentPlaceHolder1_txtsupplier").value = regname[0];
...
<%--For Busy Loader .............................--%>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Suppilier Master</asp:Label>
     </div>
     ...
     <div class="form-sec">
			...
			<div class="form-sec-row">
                <label><strong>Suppilier Code :</strong></label>
            ...
            <div class="form-sec-row">
                <label><strong>Suppilier Name :</strong></label>
          ...
          <cc1:AutoCompleteExtender ServiceMethod="SearchCustomers"   MinimumPrefixLength="1"    CompletionInterval="100" EnableCaching="false" 
            ...
            <div class="form-sec-row">
                <label><strong>Phone-1 :</strong></label>
                   ...
                   ></asp:TextBox>
                  <asp:TextBox ID="txtph1" runat="server" Width="258px" CssClass="textbox-medium1" MaxLength="10" 
                   ></asp:TextBox> 
                <div class="clear"></div>
            </div>
            <div class="form-sec-row">
                <label><strong>Phone-2 :</strong></label>
                 <asp:TextBox ID="TextBox2" runat="server" Width="40px" CssClass="textbox-medium1" Text="+91" Enabled="false"
                   ></asp:TextBox>
                 <asp:TextBox ID="txtph2" runat="server" Width="258px" CssClass="textbox-medium1"  MaxLength="10"  
                   ></asp:TextBox>
                <div class="clear"></div>
            </div>
             <div class="form-sec-row">
                ...
                <div class="form-sec">
                       <table width="100%">
                           <tr>
                               ...
                               <td>
                                   <asp:TextBox ID="txtsupplier" runat="server"   Width=""  Height="" CssClass="textbox-medium1"></asp:TextBox>
                                    <cc1:AutoCompleteExtender ServiceMethod="SearchCustomers" OnClientItemSelected="autoCompleteEx_ItemSelected" MinimumPrefixLength="1"
                                    CompletionInterval="100" EnableCaching="false" CompletionSetCount="10" TargetControlID="txtsupplier" ID="AutoCompleteExtender2" runat="server" 
  ...
  <tr style='border:1px solid black;'> 
   <td style='width:160px;'  align="center">Suppilier Name</td>
    <td style='width:110px;' align="center">Address</td>
     ...
     <div class="listing"   style='width:100%; height:500px; overflow:auto;'>
         <asp:GridView id="GridView1"  CssClass="grid" PagerStyle-CssClass="pgr" DataKeyNames ="SCode,SName" runat="server" AutoGenerateColumns="False" 
         AllowPaging="True" PageSize ="100"  ShowHeader="false"  OnPageIndexChanging="GridView1_PageIndexChanging"  SelectedRowStyle-BackColor="GreenYellow" OnRowDataBound="GridView1_RowDataBound"
                 OnRowCommand="GridView1_RowCommand" 
             OnRowDeleting="GridView1_RowDeleting" Width="100%">
                <RowStyle HorizontalAlign="Center" />
                <Columns>
                    <asp:TemplateField HeaderText="Code" ItemStyle-Width="110px"  Visible="false" ItemStyle-HorizontalAlign="Center"  >
                        <ItemTemplate>
                            <asp:Label ID="lblcode" runat="server" Text='<%# Bind("SCode") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Suppilier Name" ItemStyle-Width="160px"   ItemStyle-HorizontalAlign="Center"  >
                    ...
                    <asp:TemplateField HeaderText="Suppilier Address" ItemStyle-Width="110px"   ItemStyle-HorizontalAlign="Center"  >
                        <ItemTemplate>                        
