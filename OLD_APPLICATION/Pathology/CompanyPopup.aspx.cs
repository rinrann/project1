...
public partial class Pathology_CompanyPopup : System.Web.UI.Page
{
    PH_AgentPopup thepopup = new PH_AgentPopup(ConfigurationSettings.AppSettings["ConnectionString"].ToString());
