...
public partial class Pathology_View_Investwisecollection : System.Web.UI.Page
{
    ...
    public void bind_report()
    {
        ...
        for (int i = 0; i < ds.Tables.Count; i++)
        {
            ...
            rpt.Append("<tr>");
            rpt.Append("<td style='width:10%'><strong>Date</strong></td>");
            rpt.Append("<td style='width:6%'><strong>Slno</strong></td>");
            ...
            for (int a = 0; a < ds.Tables[i].Rows.Count; a++)
            {
                if (ds.Tables[i].Rows[a]["dates"].ToString() == "")
                {
                    ...
                    else rpt.Append("<td style='font-weight:bold;' colspan='8'>" + ds.Tables[i].Rows[a]["PatientName"].ToString() + "</td>");
                    rpt.Append("</tr>");
                }
                else
                {
