<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="PatientRequisition.aspx.cs" Inherits="Pathology_PatientRequisition" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        function calcpayableAmt() {
            //debugger;
            //alert("Hi");
            var testcost = document.getElementById("txtcost").value
            //alert(testcost);
            ...
            var payableamt = parseFloat(testcost) - parseFloat(discamt)
     ...
     <div class="form-sec">
         ...
         <div class="form-sec-row"> 
            ...
            <div class="form-sec-row">
                ...
                <asp:TextBox ID="txttestcode" runat="server" CssClass="textbox-medium1"  TextMode="MultiLine" Height="30px" ReadOnly="true"  ClientIDMode="Static"></asp:TextBox>
                      <asp:HiddenField ID="txtcurtest" runat="server" />
                  </div>
                      <div style='float:left; padding-left:1px;'><asp:Button ID="Button8" runat="server"  Height="30px"
            ...
            <div class="form-sec-row">
                ...
                <asp:TextBox ID="txttestname" runat="server" CssClass="textbox-medium1"  TextMode="MultiLine" Height="30px" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                <div class="clear"></div>
            </div>
      
            
           <div class="form-sec-row">
                <label><strong>Performing Consultant :</strong></label>
            ...
            <div class="form-sec-row">
                <label><strong>Service Cost :</strong></label>
                 <asp:TextBox ID="txtcost" runat="server" CssClass="textbox-medium1" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                <div class="clear"></div>
            </div>
         ...
         <div class="form-sec-row"  style="display:none;">
            ...
            <div class="form-sec-row">
                ...
                <%--<asp:Button ID="Button9" runat="server" Text="Prescription" Height="28px" CssClass="submit-buttonCheck" OnClick="Button9_Click"/> --%>
                <asp:Button ID="Button10" runat="server" Text="Pay Bill" Height="28px" CssClass="submit-buttonCheck" OnClick="Button10_Click"/>
