<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManufacturerPopup.aspx.cs" Inherits="Pathology_ManufacturerPopup" %>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <%--For Busy Loader End.............................--%>
       ...
       <tr>
             ...
             <label class="pname"><strong>Manufacturer Name :</strong></label> 
                ...
                <td>
                    <div class="form-sec-row"> 
             <label class="pname"><strong>Address :</strong></label> <asp:TextBox ID="txtdate" runat="server" CssClass="textbox-medium1" Width="138px" ></asp:TextBox>
            </div>
</td>
                <td>
                             <div class="form-sec-row"> 
             <label class="pname"><strong>Phone No :</strong></label> <asp:TextBox ID="txtreagent" runat="server" CssClass="textbox-medium1" Width="138px" ></asp:TextBox>
            </div>                  
</td>
                <td>
                             <div class="form-sec-row"> 
           <asp:Button ID="Button2" runat="server" Text="Search"  Height="28px" CssClass="submit-button1" onclick="Button2_Click" 
             ...
             <tr align="center">                       
                  ...
                  <asp:GridView id="GridView_popup" CssClass="grid" PagerStyle-CssClass="pgr" DataKeyNames ="MCode"  
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Manufacturer Code">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblregno" runat="server" Text='<%# Bind("MCode") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Manufacturer Name">
                       
                        <ItemTemplate>
                            <asp:Label ID="lblName" runat="server" Text='<%# Bind("MName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
