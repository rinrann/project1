<%@ Page Language="C#"  MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="ReagentStockDetails.aspx.cs" Inherits="Reagent_MedicineStockDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="pageheader">
            <asp:Label ID="Label1" runat="server">Reagent Stock Details</asp:Label>
    </div>
            ...
            <div class="formbox">
                <center>
                    ...
                    <td>  
                        ...
                        <asp:TextBox ID="TextBox8" runat="server" OnTextChanged="reagentchange" AutoPostBack="true" Width="150px"  CssClass="textbox-medium1" ></asp:TextBox>
