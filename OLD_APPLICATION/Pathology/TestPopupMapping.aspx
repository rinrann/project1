<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TestPopupMapping.aspx.cs" Inherits="Pathology_TestPopupMapping" %>
    ...
    <link href="../css/MyCss.css" rel="stylesheet" type="text/css" />
      ...
      <script type="text/javascript">
          function CloseDialog() {
              ...
              window.opener.document.getElementById("ctl00_ContentPlaceHolder1_txtname").value = a[0];
