<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TestReagentPopup.aspx.cs" Inherits="Pathology_TestReagentPopup" %>
    ...
    <link href="../css/MyCss.css" rel="stylesheet" type="text/css" /> 
      <script type="text/javascript">
          function CloseDialog() {
              ...
              window.opener.document.getElementById("ctl00_ContentPlaceHolder1_TextBox2").value = arg;
              window.close();
...
<%-- <td>
           ...
           <asp:Button ID="Button2" runat="server" Text="Search"  CssClass="submit-button1"  Height="28px" 
             ...
             <tr >                   
                  ...
                  <asp:GridView id="GridView_popup" CssClass="grid" PagerStyle-CssClass="pgr" DataKeyNames ="MappingCode" 
                 runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize ="100" 
                 Width="100%" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px"   SelectedRowStyle-BackColor="GreenYellow"
                ...
                <Columns>
                    <asp:CommandField SelectText="Select" ShowSelectButton="True" />
                     ...
                     <asp:TemplateField HeaderText="MCOde" Visible="false">
                       
                        <ItemTemplate>
                            <asp:Label ID="lblregno" runat="server" Text='<%# Bind("MappingCode") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Test Code">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lbltestno" runat="server" Text='<%# Bind("TestId") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
