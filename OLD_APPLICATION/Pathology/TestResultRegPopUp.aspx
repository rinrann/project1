<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TestResultRegPopUp.aspx.cs" Inherits="Pathology_TestResultRegPopUp" %>
  ...
  margin-right:auto; 
    ...
    <script type="text/javascript" >
        ...
        function CloseDialog() {
            ...
            if (type == 'P') {
                window.opener.document.getElementById("ctl00_ContentPlaceHolder1_txtregno").value = arg.NameValue;
                window.opener.document.getElementById("ctl00_ContentPlaceHolder1_TextBox50").value = arg.ProfessionValue;
            }
            else if (type == 'X') {
                window.opener.document.getElementById("ctl00_ContentPlaceHolder1_txtregno").value = arg.NameValue;
                window.opener.document.getElementById("ctl00_ContentPlaceHolder1_TextBox1").value = arg.ProfessionValue;
            }
            else if (type == 'U') {
                window.opener.document.getElementById("ctl00_ContentPlaceHolder1_txtregno").value = arg.NameValue;
                window.opener.document.getElementById("ctl00_ContentPlaceHolder1_TextBox1").value = arg.ProfessionValue;
                ...
                window.opener.document.getElementById("ctl00_ContentPlaceHolder1_HiddenField1").value = arg.ProfessionValue;
            }
            window.close();
