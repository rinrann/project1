<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="ExpiryAlertofReagentReport.aspx.cs" Inherits="Pathology_ExpiryAlertofReagentReport" %>
...
<script type="text/javascript" language="javascript">
    ...
    <ContentTemplate>
        <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Expiry Alert of Reagent</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
