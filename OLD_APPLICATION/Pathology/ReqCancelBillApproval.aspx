<%@ Page Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="ReqCancelBillApproval.aspx.cs" Inherits="Pathology_ReqCancelBillApproval" %>
    ...
    <%--For Busy Loader End.............................--%>
            ...
            <div id="h1">
                <div class="pageheader">
                    <asp:Label ID="Label1" runat="server">Cancellation Bill Approval Entry</asp:Label>
                </div>
            </div>
                    ...
                    <asp:GridView id="GridView1"  CssClass="grid" PagerStyle-CssClass="pgr" DataKeyNames ="VchNo" runat="server" AutoGenerateColumns="False"
                        ...
                        <RowStyle HorizontalAlign="Center" />
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Reason/Remarks"   ItemStyle-Width="5px"  ItemStyle-HorizontalAlign="Center"> 
                                    <ItemTemplate>
                                        <asp:label ID="txtReason" runat="server"  Text='<%# Bind("CancelRemarks") %>'></asp:label>
                                     </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Request Status">
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblcancel" runat="server" Text='<%# Bind("cncl") %>' Visible="false"></asp:Label>
                                    </ItemTemplate>
