<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UCDoctor.ascx.cs" Inherits="UC_UCDoctor" %>
    ...
    <tr>
        <td style='background-color:#FB7B13; color:#FFF;'>
            <table id="Table1" cellspacing="0" cellpadding="1" border="0">
                <tr>
                    <td style="WIDTH: 80px; text-align:center"  ><strong>Doctor Id</strong></td>
                    <td style="WIDTH: 292px; text-align:center" ><strong>Doctor Name</strong></td>
    ...
    <tr>
        <td colspan="3">
            <div id="div1" style="OVERFLOW: auto; height: 250px" runat="server">
                <asp:DataGrid ID="DataGrid1" ShowHeader="False" runat="server" DataKeyField="doc_id"  CssClass="grid"
                ...
                <AlternatingItemStyle BackColor="#FFDB91" />
                    <Columns>
                        <asp:TemplateColumn HeaderText="Code">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblcol1" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.doc_id") %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Book Name">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblcol2" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.doc_name") %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
