<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UCItemGroup.ascx.cs" Inherits="UCItemGroup" %>
    ...
    <tr>
        <td colspan="3">
            <div id="div1" style="OVERFLOW: auto; height: 250px" runat="server">
                <asp:DataGrid ID="DataGrid1" ShowHeader="False" runat="server" DataKeyField="MedicineGroupID"  CssClass="grid"
                ...
                <AlternatingItemStyle BackColor="#FFDB91" />
                    <Columns>
                        <asp:TemplateColumn HeaderText="Code">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblcol1" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.MedicineGroupID") %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Book Name">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblcol2" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.MedicineGroupName") %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
