<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="InstrumentAMCReport.aspx.cs" Inherits="IPD_InstrumentAMCReport" %>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server"> Instrument AMC</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
