<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="SisterCharges.aspx.cs" Inherits="IPD_SisterCharges" %>
    ...
    <asp:MultiView ID="MainView" runat="server">
        ...
        <div class="form-sec">
            ...
            <div class="form-sec-row">
                ...
                <asp:DropDownList ID="CenterNameList" runat="server" CssClass="combo-big1">
                </asp:DropDownList>
                <div class="clear"></div>
            </div>
            ...
            <asp:Label ID="Label2" runat="server" Text="SHIFTING CHARGE" Font-Bold="True" ForeColor="ActiveCaption"></asp:Label>
            <div class="form-sec-row">
...
<div class="listing"   style='width:100%; height:200px; overflow:auto;'>
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" CssClass="grid" PagerStyle-CssClass="pgr"
        ...
        DataKeyNames="CenterCode"  Width="100%"
        ...
        <Columns>
            <asp:TemplateField HeaderText="Id" Visible="false">
              ...
              <asp:TemplateField HeaderText="Centre" >
                <ItemTemplate>
                    &nbsp;<asp:Label ID="lblcentre" runat="server" Text='<%# Bind("CenterName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Day Charge">
                <ItemTemplate>
                    <asp:Label ID="lblDayShift" runat="server" Text='<%# Bind("DayCharge") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Night Charge">
                <ItemTemplate>
                    <asp:Label ID="lblNightShift" runat="server" Text='<%# Bind("NightCharge") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Day+Night Charge">
                <ItemTemplate>
                    <asp:Label ID="lblDayNightShift" runat="server" Text='<%# Bind("DayNightCharge") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
