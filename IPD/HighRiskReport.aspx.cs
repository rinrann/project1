...
public partial class IPD_HighRiskReport : System.Web.UI.Page
{
    ...
    {
        Page.Title = "Heart Patient";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "HEART PATIENT", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>হার্ট অ্যাটাক, অনিয়মিত হৃদস্পন্দন, অনিয়ন্ত্রিত ব্লাড প্রেসার, সুগারের সমস্যা, বেশী বয়স</td>");
            rpt.Append("</tr >");
            ...
            rpt.Append("<tr style='height:35px'>");
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>হঠাৎ রোগীর হৃদ স্পন্দন থেমে যেতে পারে, রোগী মারা যেতে পারে, ফুসফুস কিডনি লিভার বিকল হতে পারে, যে কোন মুহূর্তে রোগীকে অন্যত্র নিয়ে যেতে হতে পারে, এই রোগের চিকিৎসার কোন গ্যারান্টী নেই</td>");
            rpt.Append("</tr >");
            rpt.Append("</table>");
            rpt.Append("<br/>");
            rpt.Append("<table width='100%'>");
    ...
    public void PDF()
    {
        string filename = "HeartPatient" + TextBox1.Text;
