<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="BroChopReport.aspx.cs" Inherits="IPD_BroChopReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Neonatal Brochop Numonia</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
