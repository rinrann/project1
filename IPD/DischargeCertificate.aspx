<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="DischargeCertificate.aspx.cs" Inherits="IPD_DischargeCertificate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript" language="javascript">
       ...
       function ShowDialogDuplicate() {
           var rtvalue = window.open("DischargePopup.aspx", "sss", "Width:800px; Height:550px; dialogLeft:250px;");
...
--%>
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Discharge Certificate</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
         ...
         <table width="100%">
           ...
           <td>  
               <asp:TextBox ID="TextBox1" CssClass="textbox-medium1"  runat="server"  Enabled="true"
                   Width="150px" ></asp:TextBox></td>
           <td> <asp:Button ID="Button3" runat="server" Text="Search" Width="80px"  CssClass="submit-button"  OnClientClick="ShowDialog()"/></td>
           ...
           <td>  <label><strong>Discharge Date :</strong></label> </td>
           <td colspan="2">  
               <asp:TextBox ID="TextBox2" CssClass="textbox-medium1"  runat="server"  
                   Width="150px" ></asp:TextBox>
               
            <cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" TargetControlID="TextBox2"
                                            Mask="99/99/9999" MessageValidatorTip="true" MaskType="Date" DisplayMoney="Left"
                                            AcceptNegative="Left" ErrorTooltipEnabled="True" CultureName="en-GB" />

           </td> 
        
              <td>  <label><strong>Discharge Condition :</strong></label> </td>
                 <td colspan="2">  
                      <asp:TextBox ID="TextBox3" CssClass="textbox-medium1"  TextMode="MultiLine" Height="50px"  runat="server"  
                   Width="200px" ></asp:TextBox>
                        <cc1:AutoCompleteExtender ServiceMethod="SearchCondition"     MinimumPrefixLength="1"
           CompletionInterval="100" EnableCaching="false" 
           CompletionSetCount="10" TargetControlID="TextBox3"  ID="AutoCompleteExtender1" runat="server" FirstRowSelected = "false" ></cc1:AutoCompleteExtender>
            </td>
         ...
         <table width="100%">
           ...
           <td>  <label><strong>Registration No :</strong></label> </td>
           <td>  
               <asp:TextBox ID="TextBox11" CssClass="textbox-medium1"  runat="server" 
              ...
              <td>  <label><strong>Select Language :</strong></label> </td>
                 <td>  
                     <asp:DropDownList ID="DropDownList2" runat="server" CssClass="textbox-medium1" 
                        ...
                        <td>  <asp:Button ID="Button2" runat="server" Text="Generate Report" 
                        ...
                        <td align="center">
                         ...
                         <input type="button" id="cmdPrint"  runat="server" value="Print" style="width:70px; font-size:x-small" onclick="javascript:printDiv('mydiv')"/>
                            <asp:Button ID="btnPDF" runat="server"  style="width:70px; font-size:x-small"  
                                Text="PDF" onclick="btnPDF_Click1"  />
