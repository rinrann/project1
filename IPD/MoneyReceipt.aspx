<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="MoneyReceipt.aspx.cs" Inherits="IPD_MoneyReceipt" %>
...
<script type="text/javascript" language="javascript">
    ...
    function ShowDialog() {
        ...
        var rtvalue = window.open("../Account/RegistrationPopup.aspx", "sss", "Width:800px; Height:550px; dialogLeft:250px;");
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Money Receipt</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
           ...
           <td  style='width:155px;'>  <label><strong>Registration No :</strong></label> </td>
           <td  style='width:170px;'>  <asp:TextBox ID="txtreg" CssClass="textbox-medium1"  runat="server" Width="150px"></asp:TextBox></td>
           <td style='width:125px;'> <asp:Button ID="Button3" runat="server" Text="Search"  CssClass="submit-button"  OnClientClick="ShowDialog()"/></td>
         
                        <td  style='width:125px;'>   <asp:Button ID="Button4" runat="server" Text="Fetch" CssClass="submit-button" onclick="Button4_Click" /></td>

                        <td>   <asp:Button ID="Button1" runat="server" Text="Genarate Report" 
                                CssClass="submit-generate" onclick="Button1_Click"  /></td>
  
           </tr>
           <tr><td align="center" colspan="5"> <div style='width:100%; height:auto; overflow:auto;'>
                  <asp:GridView id="GridView1" CssClass="grid" PagerStyle-CssClass="pgr" DataKeyNames ="LedgerFK"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Reason">                       
                      ...
                      <asp:TemplateField HeaderText="AmountinWords" Visible="false">                       
                        <ItemTemplate>
                            <asp:Label ID="lblAmountinWords" runat="server" Text='<%# Bind("AmountinWords") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
