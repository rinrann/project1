...
public partial class IPD_PoppReqPatient : System.Web.UI.Page
{
    ...
    {
        GridView1.DataSource = thereg.GridPopup(txtreg.Text.Trim(), txtname.Text.Trim(), txtph.Text.Trim(), txtaddress.Text.Trim(), Session["CoCode"].ToString().Trim());
        GridView1.DataBind();
    }
