<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="Eclamsia.aspx.cs" Inherits="IPD_Eclamsia" %>
...
<script type="text/javascript" language="javascript">
 ...
 <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Eclamsia</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
