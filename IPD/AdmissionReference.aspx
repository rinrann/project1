<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="AdmissionReference.aspx.cs" Inherits="Pathology_AdmissionReference" %>
...
<asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Admission Reference Certificate</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
