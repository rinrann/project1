<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="PoisionIntake.aspx.cs" Inherits="IPD_PoisionIntake" %>
...
<asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Poision Intake</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
