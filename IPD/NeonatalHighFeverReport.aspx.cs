...
public partial class IPD_NeonatalHighFeverReport : System.Web.UI.Page
{
    Main Objmain = new Main(ConfigurationSettings.AppSettings["ConnectionString"].ToString());
    Eclamsia12 thehighfever = new Eclamsia12(ConfigurationSettings.AppSettings["ConnectionString"].ToString());
    System.Text.StringBuilder rpt = new System.Text.StringBuilder();
    String Date = DateTime.Now.ToString("dd/MM/yyyy");
    protected void Page_Load(object sender, EventArgs e)
    {
        Page.Title = "Neonatal High Fever";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "NEONATAL HIGH FEVER", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
          ...
          DataTable dt = thehighfever.GetPatientDtls(TextBox1.Text, Session["CoCode"].ToString().Trim());
        if (dt.Rows.Count > 0)
        {
            rpt.Append("<br/>");
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>প্রচন্ড জ্বর,জীবনী শক্তি কম, ফুসফুস কমজোরী, হার্ট দূর্বল, খাওয়ানোর সমস্যা, যখন তখন বাচ্চার অবস্থা খারাপ হওয়ার প্রনণতা</td>");
            rpt.Append("</tr >");
            ...
            rpt.Append("<tr style='height:35px'>");
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>ইনফেকসন বা সেপশিস হতে পারে, শ্বাসকষ্ট হতে পারে, হঠাৎ হৃদযন্র বিকল হতে পারে, পেট ফুলে যেতে পারে, ব্রেনে রক্তপাত হতে পারে, যখন তখন বাচ্চার অবস্থা খারাপ হতে পারে, এমন কি মারা ও যেতে পারে, যে কোন মুহূর্তে অন্যত্র নিয়ে যেতে হতে পারে</td>");
            rpt.Append("</tr >");
            rpt.Append("</table>");
            rpt.Append("<br/>");
            rpt.Append("<table width='100%'>");
    ...
    public void PDF()
    {
        string filename = "NeonatalHighFever" + TextBox1.Text;
