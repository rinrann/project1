<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="ServiceTemplate.aspx.cs" Inherits="IPD_ServiceTemplate" %>
...
<script language="javascript" type="text/javascript">
    ...
    function autoCompleteEx_ItemSelected(sender, args) {
        ...
        document.getElementById("ctl00_ContentPlaceHolder1_txtTemplateName").value = regname[0];
...
<%--For Busy Loader .............................--%> 
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <ContentTemplate>
         ...
         <asp:Label ID="Label1" runat="server">Ser & Cons Template</asp:Label>
     </div>
...
<asp:MultiView ID="MainView" runat="server">
            ...
            <asp:HiddenField ID="TextBox4" runat="server" />
                ...
                <label><strong>Template Category :</strong></label>
         <asp:DropDownList ID="DropDownList1" runat="server"  CssClass="textbox-medium1" >
			...
			<div class="form-sec-row">
                ...
                <asp:TextBox ID="txtTemplateName" runat="server" CssClass="textbox-medium1" ></asp:TextBox>
                <cc1:AutoCompleteExtender ServiceMethod="Searchtemplate" OnClientItemSelected="autoCompleteEx_ItemSelected" MinimumPrefixLength="1"
                                    CompletionInterval="100" EnableCaching="false" CompletionSetCount="10" TargetControlID="txtTemplateName" ID="AutoCompleteExtender2" runat="server" 
                ...
                <asp:TextBox ID="txtserviceCharge" runat="server" MaxLength="5"  CssClass="textbox-medium1" ></asp:TextBox>
                <div class="clear"></div>
            </div>
...
<td align="center">
 ...
 <table border="1" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr style='border:1px solid black;'> 
   ...
   <td style='width:120px;'  align="center">Template Name</td> 
...
<div class="listing"  style='width:100%; height:500px; overflow:auto;'>
         <asp:GridView id="GridView1"  CssClass="grid"
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="Template Name"  ItemStyle-HorizontalAlign="Center" ItemStyle-Width="120px"  >                       
                        <ItemTemplate>
