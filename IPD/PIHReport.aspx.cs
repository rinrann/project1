...
public partial class IPD_PIHReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "PIH", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>প্রেসার খুব বেশী, বাচ্চার বৃদ্ধি কম, পা ফোলা,এক্লামশিয়া বা গর্ভাকালীন খিঁচুনি হতে পারে</td>");
            rpt.Append("</tr >");
            ...
            rpt.Append("<tr style='height:35px'>");
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>এক্লামশিয়া বা গর্ভাকালীন খিঁচুনি হতে পারে, অজ্ঞান অবস্থা, বেশী প্রেসার, নাক মুখ দিয়ে গেঁজা বেরুনো, এই অবস্থায় প্রসব করানোর ঝুঁকি, হঠাৎ রোগীর হৃদ স্পন্দন থেমে যেতে পারে, রোগী মারা যেতে পারে, বাচ্চাও মারা যেতে পারে, ফুসফুস কিডনি লিভার বিকল হতে পারে, যে কোন মুহূর্তে রোগীকে অন্যত্র নিয়ে যেতে হতে পারে, দীর্ঘ মেয়াদী হাই প্রেসার থেকে যেতে পারে, এই রোগের চিকিৎসার কোন গ্যারান্টী নেই</td>");
            rpt.Append("</tr >");
            rpt.Append("</table>");
            rpt.Append("<br/>");
            rpt.Append("<table width='100%'>");
    ...
    public void PDF()
    {
        string filename = "PIH" + TextBox1.Text;
