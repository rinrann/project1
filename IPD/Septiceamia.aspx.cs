...
public partial class IPD_Septiceamia : System.Web.UI.Page
{
    ...
    {
        Page.Title = "Septicemia";
        if (Session["userName"] == null)
        {
            Response.Redirect("../LoginPage.aspx");
        }
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "SEPTICEAMIA", checkAccessType.ViewAction) == false)
        {
    ...
    public void GetHearder_Detail()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt.Append("<td style='font-family:Verdana;font-size:small; text-align:left'>সারা শরীরে ইনফেকশন ছড়িযে গেছে,জীবনী শক্তি কম, ফুসফুস কমজোরী, হার্ট দূর্বল, অন্যান্য অঙ্গ ভাল কাজ করছে না, খাওয়ানোর সমস্যা, যখন তখন বাচ্চার অবস্থা খারাপ হওয়ার প্রনণতা</td>");
            rpt.Append("</tr >");
    ...
    public void PDF()
    {
        string filename = "Septicemia" + TextBox1.Text;
