<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="OTInstrumentRepair.aspx.cs" Inherits="IPD_OTInstrumentRepair" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="pageheader">
                <asp:Label ID="Label1" runat="server">OT Instrument Repair</asp:Label>
            </div>
         ...
         <div class="listing"  style='width:100%; height:300px; overflow:auto;'>
               ...
               <asp:TemplateField HeaderText="Instrument Type id" Visible="false">
                        ...
                        <asp:TemplateField HeaderText="Repair Cost">
                            <ItemTemplate>
                                <asp:Label ID="RepairCost" runat="server" Text='<%# Bind("RepairCost") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
