...
public partial class IPD_Deliverpopup : System.Web.UI.Page
{
    RegistrationPopup12 thereg = new RegistrationPopup12(ConfigurationSettings.AppSettings["ConnectionString"].ToString());
    ...
    {
        GridView1.DataSource = thereg.GridPopup2(txtreg.Text.Trim(), txtname.Text.Trim(), txtph.Text.Trim(), txtaddress.Text.Trim(), Session["CoCode"].ToString().Trim(), Session["YearCode"].ToString().Trim());
        GridView1.DataBind();
    }
