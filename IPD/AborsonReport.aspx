<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="AborsonReport.aspx.cs" Inherits="IPD_AborsonReport" %>
...
<asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <ContentTemplate>
     <div class="pageheader">
         <asp:Label ID="Label1" runat="server">MTP Consent</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
