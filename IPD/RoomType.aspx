<%@ Page Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="RoomType.aspx.cs" Inherits="Master_RoomType" %>
...
<script language="javascript" type="text/javascript">
    ...
    function Calling() {
        $("input[id$='txtRoomCatName']").focus(function () {
            $("input[id$='txtRoomCatName']").addClass('textboxborder');
        });
        $("input[id$='txtRoomCatName']").blur(function () {
            $("input[id$='txtRoomCatName']").removeClass('textboxborder');
        });
        $("input[id$='Button1']").click(function () {
            if ($("input[id$='txtRoomCatName']").val() == '') {
                $("input[id$='txtRoomCatName']").addClass('textboxerr');
            }
            if ($("input[id$='txtRoomCatName']").val() == '') {
                alert('Please Enter RoomCategory name Properly!');
                $("input[id$='txtRoomCatName']").focus();
                $("input[id$='txtRoomCatName']").addClass('textboxerr');
                return false;
            }
            else {
                $("input[id$='txtRoomCatName']").removeClass('textboxerr');
            }
        });
    }
...
<%--For Busy Loader .............................--%>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="pageheader">
                <asp:Label ID="Label1" runat="server">Room Type</asp:Label>
            </div>
            ...
            <asp:MultiView ID="MainView" runat="server">
                ...
                <div class="form-sec">
                    ...
                    <div class="form-sec-row">
                        <label>
                        <strong>
                        RoomCategory Name :</strong></label>
                        <asp:TextBox ID="txtRoomCatName" runat="server" CssClass="textbox-medium1" ></asp:TextBox>
                        <cc1:AutoCompleteExtender ServiceMethod="Searchroomtype" OnClientItemSelected="autoCompleteEx_ItemSelected" MinimumPrefixLength="1"
                                    CompletionInterval="100" EnableCaching="false" CompletionSetCount="10" TargetControlID="txtRoomCatName" ID="AutoCompleteExtender2" runat="server" 
  ...
  <tr style='border:1px solid black;'> 
   <td style='width:150px;' align="center">RoomCategory Name</td> 
      <td style='width:150px;' align="center">Pattern Text</td> 
          ...
          <td style='width:70px;' align="center" id="coldel" runat="server">Delete</td>
            ...
            <div class="listing"  style='width:100%; height:500px; overflow:auto;'>
                <asp:GridView id="GridView1"  Width="100%" CssClass="grid" PagerStyle-CssClass="pgr"
                 DataKeyNames ="RoomCategoryID" runat="server"  PageSize="100"
                 ...
                 OnPageIndexChanging="GridView1_PageIndexChanging" 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="RoomCategory ID" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="RoomCategoryID" runat="server" Text='<%# Bind("RoomCategoryID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="RoomCategory Name"  ItemStyle-Width="150px">
                            <ItemTemplate>
                                <asp:Label ID="RoomCategoryName" runat="server" Text='<%# Bind("RoomCategoryName") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Pattern Text"  ItemStyle-Width="150px">
                            <ItemTemplate>
