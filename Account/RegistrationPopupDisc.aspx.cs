...
public partial class Account_RegistrationPopupDisc : System.Web.UI.Page
{
    RegistrationPopupDisc thehlpr = new RegistrationPopupDisc(ConfigurationSettings.AppSettings["ConnectionString"].ToString());
    ...
    {
        GridView1.DataSource = thehlpr.GridPopupDisc(txtreg.Text.Trim(), txtname.Text.Trim(), txtph.Text.Trim(), txtaddress.Text.Trim());
        GridView1.DataBind();
    }
