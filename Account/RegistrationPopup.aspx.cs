...
public partial class Pathology_RegistrationPopup : System.Web.UI.Page
{
    ...
    {
        GridView1.DataSource = thereg.AnutimePaymentPopup(txtreg.Text.Trim(), txtname.Text.Trim(), txtph.Text.Trim(), txtaddress.Text.Trim(), Session["CoCode"].ToString().Trim());
        GridView1.DataBind();
    }
    public void GridFill2()
    {
        GridView1.DataSource = thereg.RegistrationPopup( Session["CoCode"].ToString().Trim(),"", txtname.Text.Trim(), txtph.Text.Trim(), txtaddress.Text.Trim());
        GridView1.DataBind();
    }
