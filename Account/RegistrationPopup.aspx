...
<td>
          ...
          <td>
           ...
           <asp:Button ID="Button2" runat="server" Text="Search"  CssClass="submit-button1" onclick="Button2_Click" 
            ...
            <tr><td colspan="5"><asp:Button Text="IPD Patient" BorderStyle="None" ID="Tab1" Width="145px"  Height="40px" 
                    CssClass="Initial" runat="server" onclick="Tab1_Click"/>
                <asp:Button Text="Dialysis Patient" BorderStyle="None" ID="Tab2" CssClass="Initial"  Width="145px"  Height="40px" 
                    runat="server" onclick="Tab2_Click"/></td></tr>  
             <tr align="center">                       
                   <td colspan="5">
