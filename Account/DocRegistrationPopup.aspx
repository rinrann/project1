<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocRegistrationPopup.aspx.cs" Inherits="Account_DocRegistrationPopup" %>
  ...
  margin-right:auto; 
    ...
    <script type="text/javascript" >
        ...
        function CloseDialog() {
            ...
            window.opener.document.getElementById("ctl00_ContentPlaceHolder1_txtdocid").value = arg.NameValue;
            window.opener.document.getElementById("ctl00_ContentPlaceHolder1_HiddenField1").value = a[2];
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
            <ContentTemplate>
             ...
             <label class="pname"><strong>Refer By :</strong></label> 
                ...
                <td>
                    <div class="form-sec-row"> 
             <label class="pname"><strong>Search Name :</strong></label> 
                    ...
                    <tr align="center">                       
                        <td colspan="3">
                            <div  style='width:100%; height:auto; overflow:auto;'>
                                ...
                                <asp:GridView id="GridView1" CssClass="grid" PagerStyle-CssClass="pgr" DataKeyNames ="doc_id" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize ="1000"   SelectedRowStyle-BackColor="GreenYellow" Width="100%" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" OnRowCommand="GridView1_RowCommand" onpageindexchanging="GridView1_PageIndexChanging">
                                <Columns>
                                    <asp:CommandField SelectText="Select" ShowSelectButton="True" />
                                    <asp:TemplateField HeaderText="Doctor Id">
                       
                                    <ItemTemplate>
                                        <asp:Label ID="lblid" runat="server" Text='<%# Bind("doc_id") %>'></asp:Label>
                                    </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Reg No">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblregno" runat="server" Text='<%# Bind("DrRegNo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Name">
                       
                                        <ItemTemplate>
                                            <asp:Label ID="lblName" runat="server" Text='<%# Bind("dname") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Address">
                                     ...
                                     <asp:TemplateField HeaderText="City" ControlStyle-Width="200px">
                       
                                        <ItemTemplate>
                                            <asp:Label ID="lbllcity" runat="server" Text='<%# Bind("City") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <%--<asp:TemplateField HeaderText="Speciality">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblspl" runat="server" Text='<%# Bind("SpecialistIn1") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField> --%>
