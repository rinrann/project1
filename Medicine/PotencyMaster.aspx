<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="PotencyMaster.aspx.cs" Inherits="Medicine_PotencyMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function Calling() {
            ...
            $("input[id$='txtchemicalname']").keypress(function (e) {
                if (e.which === 32)
                    return false;
            });
...
<%--For Busy Loader .............................--%>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Potency Master</asp:Label>
     </div>
     ...
     <asp:HiddenField ID="HiddenField1" runat="server" />
			<div class="form-sec-row">
                <label><strong>Enter Potency :</strong></label>
                 <asp:TextBox ID="txtchemicalname" runat="server" CssClass="textbox-medium1" 
                   ></asp:TextBox>
                <cc1:AutoCompleteExtender ServiceMethod="SearchPotency" OnClientItemSelected="autoCompleteEx_ItemSelected" MinimumPrefixLength="1"
     ...
     <div class="listing"   style='width:100%; height:600px; overflow:auto;'>
         <asp:GridView id="GridView1"  CssClass="grid"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Potency">
                       
                        <ItemTemplate>
                            <asp:Label ID="lblname" runat="server" Text='<%# Bind("PotencyName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
