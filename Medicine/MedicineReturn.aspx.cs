...
public partial class Medicine_MedicineReturn : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "MEDICINE RETURN", checkAccessType.InsertAction) == false)
        {
    ...
    {
        DropDownFill();
        TextBox t1, t2, t3, t4, t5,t6,t7,t8; DropDownList d1, d2, d3,d4,d5;
        ...
        if (dtPurchaseMedicine.Rows.Count > 0)
        {
            ...
            //txtBillNo.Text = dtPurchaseMedicine.Rows[0]["chno"].ToString();
           // TextBox1.Text = dtPurchaseMedicine.Rows[0]["Discount"].ToString();
            ...
            for (int i = 0, t = 1; i < dtPurchaseMedicine.Rows.Count; i++, t++)
            {
               // t1 = (TextBox)Page.FindControl("ctl00$ContentPlaceHolder1$txtBatch" + t.ToString());
                ...
                t7 = (TextBox)Page.FindControl("ctl00$ContentPlaceHolder1$txtBill" + t.ToString());
                t8 = (TextBox)Page.FindControl("ctl00$ContentPlaceHolder1$txtmrp" + t.ToString());
                ...
                d1.SelectedValue = dtPurchaseMedicine.Rows[i]["MedicineID"].ToString().Trim();
                ...
                t1.Text = dtPurchaseMedicine.Rows[i]["exdate"].ToString();//String.Format("{0:0.00}", 123.4567);
                t2.Text = String.Format("{0:0.00}",dtPurchaseMedicine.Rows[i]["Qty"].ToString());
                t3.Text = dtPurchaseMedicine.Rows[i]["PricePerUnit"].ToString();
                t4.Text = dtPurchaseMedicine.Rows[i]["TotalPrice"].ToString();
                t5.Text = dtPurchaseMedicine.Rows[i]["lessper"].ToString();
                t6.Text = dtPurchaseMedicine.Rows[i]["taxper"].ToString();
                t7.Text = dtPurchaseMedicine.Rows[i]["chno"].ToString();
                t8.Text = dtPurchaseMedicine.Rows[i]["SELLAMOUNT"].ToString();
            }
            Button1.Text = "Update";
            if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "PURCHASE RETURN", checkAccessType.UpdateAction) == false)
            {
                Button1.Enabled = false;
            }
            else
    ...
    private void ResetAllFields()
    {
        ...
        for (int i = 1; i <= 12; i++)
        {
            ...
            TextBox txtBill = (TextBox)divContent.FindControl("txtBill" + i.ToString());
    ...
    private void DropDownFill()
    {
        for (int i = 1; i <= 12; i++)
        {
            ...
            ddlMedicine.DataSource = theHelper.MedicineDropdown(DropDownList1.SelectedValue.ToString(), Session["CoCode"].ToString().Trim(), Session["YearCode"].ToString().Trim(),type);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                theHelper.UpdatePurchaseMedicine(compcode, yearcode, txtPurchaseMedicineId.Text, DropDownList1.SelectedValue, testdate.ToString(),total.ToString(), TextBox1.Text, txtlessper.Text, txtTaxper.Text);
    ...
    private void InsertPurchaseMedicine(string compcode,string yearcode,double total)
    {
        ...
        if (ddlMedi1.SelectedIndex > 0 && ddlBatch1.SelectedIndex> 0 && Calendar2.Text.Length > 0 && txtQty1.Text.Length > 0 && txtUnitPrice1.Text.Length > 0 && txtTotalPrice1.Text.Length > 0)
        {
            ...
            theHelper.InsertPurchaseMedicine(i, compcode, yearcode, ddlMediSubGrp1.SelectedValue, TextBox1.Text, total.ToString(), txtPurchaseMedicineId.Text, DropDownList1.SelectedValue, testdate.ToString("yyyy-MM-dd"), txtBill1.Text, ddlMfg1.SelectedValue, ddlMediGrp1.SelectedValue, ddlMedi1.SelectedValue, ddlBatch1.SelectedValue, testdate1.ToString("yyyy-MM-dd"), txtQty1.Text, txtUnitPrice1.Text, txtTotalPrice1.Text, Session["userName"].ToString(), txttrendDisc1.Text, txtstax1.Text, txtlessper.Text, txtTaxper.Text);
        }
        ...
        if (ddlMedi4.SelectedIndex > 0 && ddlBatch4.SelectedIndex > 0 && Calendar5.Text.Length > 0 && txtQty4.Text.Length > 0 && txtUnitPrice4.Text.Length > 0 && txtTotalPrice4.Text.Length > 0)
        {
            ...
            theHelper.InsertPurchaseMedicine(i, compcode, yearcode, ddlMediSubGrp4.SelectedValue, TextBox1.Text, total.ToString(), txtPurchaseMedicineId.Text, DropDownList1.SelectedValue, testdate.ToString("yyyy-MM-dd"), txtBill4.Text, ddlMfg4.SelectedValue, ddlMediGrp4.SelectedValue, ddlMedi4.SelectedValue, ddlBatch4.SelectedValue, testdate4.ToString("yyyy-MM-dd"), txtQty4.Text, txtUnitPrice4.Text, txtTotalPrice4.Text, Session["userName"].ToString(), txttrendDisc4.Text, txtstax4.Text, txtlessper.Text, txtTaxper.Text);
        }
        ...
        if (ddlMedi7.SelectedIndex > 0 && ddlBatch7.SelectedIndex > 0 && Calendar8.Text.Length > 0 && txtQty7.Text.Length > 0 && txtUnitPrice7.Text.Length > 0 && txtTotalPrice7.Text.Length > 0)
        {
            ...
            theHelper.InsertPurchaseMedicine(i, compcode, yearcode, ddlMediSubGrp7.SelectedValue, TextBox1.Text, total.ToString(), txtPurchaseMedicineId.Text, DropDownList1.SelectedValue, testdate.ToString("yyyy-MM-dd"), txtBill7.Text, ddlMfg7.SelectedValue, ddlMediGrp7.SelectedValue, ddlMedi7.SelectedValue, ddlBatch7.SelectedValue, testdate7.ToString("yyyy-MM-dd"), txtQty7.Text, txtUnitPrice7.Text, txtTotalPrice7.Text, Session["userName"].ToString(), txttrendDisc7.Text, txtstax7.Text, txtlessper.Text, txtTaxper.Text);
        }
        if (ddlMedi8.SelectedIndex > 0 && ddlBatch8.SelectedIndex > 0 && Calendar9.Text.Length > 0 && txtQty8.Text.Length > 0 && txtUnitPrice8.Text.Length > 0 && txtTotalPrice8.Text.Length > 0)
        {
            ...
            theHelper.InsertPurchaseMedicine(i, compcode, yearcode, ddlMediSubGrp8.SelectedValue, TextBox1.Text, total.ToString(), txtPurchaseMedicineId.Text, DropDownList1.SelectedValue, testdate.ToString("yyyy-MM-dd"), txtBill8.Text, ddlMfg8.SelectedValue, ddlMediGrp8.SelectedValue, ddlMedi8.SelectedValue, ddlBatch8.SelectedValue, testdate8.ToString("yyyy-MM-dd"), txtQty8.Text, txtUnitPrice8.Text, txtTotalPrice8.Text, Session["userName"].ToString(), txttrendDisc8.Text, txtstax8.Text, txtlessper.Text, txtTaxper.Text);
        }
        if (ddlMedi9.SelectedIndex > 0 && ddlBatch9.SelectedIndex > 0 && Calendar10.Text.Length > 0 && txtQty9.Text.Length > 0 && txtUnitPrice9.Text.Length > 0 && txtTotalPrice9.Text.Length > 0)
        {
            ...
            theHelper.InsertPurchaseMedicine(i, compcode, yearcode, ddlMediSubGrp9.SelectedValue, TextBox1.Text, total.ToString(), txtPurchaseMedicineId.Text, DropDownList1.SelectedValue, testdate.ToString("yyyy-MM-dd"), txtBill9.Text, ddlMfg9.SelectedValue, ddlMediGrp9.SelectedValue, ddlMedi9.SelectedValue, ddlBatch9.SelectedValue, testdate9.ToString("yyyy-MM-dd"), txtQty9.Text, txtUnitPrice9.Text, txtTotalPrice9.Text, Session["userName"].ToString(), txttrendDisc9.Text, txtstax9.Text, txtlessper.Text, txtTaxper.Text);
        }
        if (ddlMedi10.SelectedIndex > 0 && ddlBatch10.SelectedIndex > 0 && Calendar11.Text.Length > 0 && txtQty10.Text.Length > 0 && txtUnitPrice10.Text.Length > 0 && txtTotalPrice10.Text.Length > 0)
        {
            ...
            theHelper.InsertPurchaseMedicine(i, compcode, yearcode, ddlMediSubGrp10.SelectedValue, TextBox1.Text, total.ToString(), txtPurchaseMedicineId.Text, DropDownList1.SelectedValue, testdate.ToString("yyyy-MM-dd"), txtBill10.Text, ddlMfg10.SelectedValue, ddlMediGrp10.SelectedValue, ddlMedi10.SelectedValue, ddlBatch10.SelectedValue, testdate10.ToString("yyyy-MM-dd"), txtQty10.Text, txtUnitPrice10.Text, txtTotalPrice10.Text, Session["userName"].ToString(), txttrendDisc10.Text, txtstax10.Text, txtlessper.Text, txtTaxper.Text);
        }
        if (ddlMedi11.SelectedIndex > 0 && ddlBatch11.SelectedIndex > 0 && Calendar12.Text.Length > 0 && txtQty11.Text.Length > 0 && txtUnitPrice11.Text.Length > 0 && txtTotalPrice1.Text.Length > 0)
        {
            ...
            theHelper.InsertPurchaseMedicine(i, compcode, yearcode, ddlMediSubGrp11.SelectedValue, TextBox1.Text, total.ToString(), txtPurchaseMedicineId.Text, DropDownList1.SelectedValue, testdate.ToString("yyyy-MM-dd"), txtBill11.Text, ddlMfg11.SelectedValue, ddlMediGrp11.SelectedValue, ddlMedi11.SelectedValue, ddlBatch11.SelectedValue, testdate11.ToString("yyyy-MM-dd"), txtQty11.Text, txtUnitPrice11.Text, txtTotalPrice11.Text, Session["userName"].ToString(), txttrendDisc11.Text, txtstax11.Text, txtlessper.Text, txtTaxper.Text);
        }
        if (ddlMedi12.SelectedIndex > 0 && ddlBatch12.SelectedIndex > 0 && Calendar13.Text.Length > 0 && txtQty12.Text.Length > 0 && txtUnitPrice12.Text.Length > 0 && txtTotalPrice12.Text.Length > 0)
        {
            ...
            theHelper.InsertPurchaseMedicine(i, compcode, yearcode, ddlMediSubGrp12.SelectedValue, TextBox1.Text, total.ToString(), txtPurchaseMedicineId.Text, DropDownList1.SelectedValue, testdate.ToString("yyyy-MM-dd"), txtBill12.Text, ddlMfg12.SelectedValue, ddlMediGrp12.SelectedValue, ddlMedi12.SelectedValue, ddlBatch12.SelectedValue, testdate12.ToString("yyyy-MM-dd"), txtQty12.Text, txtUnitPrice12.Text, txtTotalPrice12.Text, Session["userName"].ToString(), txttrendDisc12.Text, txtstax12.Text, txtlessper.Text, txtTaxper.Text);
        }
        //theHelper.InsUpdInv(compcode, yearcode, txtPurchaseMedicineId.Text.Trim(), "Q", Session["userName"].ToString());
    }
    ...
    protected void txtQty1_TextChanged(object sender, EventArgs e)
    {
        ...
        Double totAmt = calcTotAmt(txtQty1.Text, txtUnitPrice1.Text, txttrendDisc1.Text, txtstax1.Text, txtmrp1.Text);
    ...
    protected void txtQty2_TextChanged(object sender, EventArgs e)
    {
       /* if (txtQty2.Text != "")
        ...
        Double totAmt = calcTotAmt(txtQty2.Text, txtUnitPrice2.Text, txttrendDisc2.Text, txtstax2.Text, txtmrp2.Text);
        if (totAmt > 0.00)
        {
    ...
    protected void txtQty3_TextChanged(object sender, EventArgs e)
    {
       /* if (txtQty3.Text != "")
        ...
        Double totAmt = calcTotAmt(txtQty3.Text, txtUnitPrice3.Text, txttrendDisc3.Text, txtstax3.Text, txtmrp3.Text);
        if (totAmt > 0.00)
        {
    ...
    protected void txtQty4_TextChanged(object sender, EventArgs e)
    {
        ...
        Double totAmt = calcTotAmt(txtQty4.Text, txtUnitPrice4.Text, txttrendDisc4.Text, txtstax4.Text, txtmrp4.Text);
        if (totAmt > 0.00)
        {
    ...
    protected void txtQty5_TextChanged(object sender, EventArgs e)
    {
       /* if (txtQty5.Text != "")
        ...
        Double totAmt = calcTotAmt(txtQty5.Text, txtUnitPrice5.Text, txttrendDisc5.Text, txtstax5.Text, txtmrp5.Text);
        if (totAmt > 0.00)
        {
    ...
    protected void txtQty6_TextChanged(object sender, EventArgs e)
    {
        ...
        Double totAmt = calcTotAmt(txtQty6.Text, txtUnitPrice6.Text, txttrendDisc6.Text, txtstax6.Text, txtmrp6.Text);
        if (totAmt > 0.00)
        {
    ...
    protected void txtQty7_TextChanged(object sender, EventArgs e)
    {
        ...
        Double totAmt = calcTotAmt(txtQty7.Text, txtUnitPrice7.Text, txttrendDisc7.Text, txtstax7.Text, txtmrp7.Text);
        if (totAmt > 0.00)
        {
    ...
    protected void txtQty8_TextChanged(object sender, EventArgs e)
    {
       /* if (txtQty8.Text != "")
        ...
        Double totAmt = calcTotAmt(txtQty8.Text, txtUnitPrice8.Text, txttrendDisc8.Text, txtstax8.Text, txtmrp8.Text);
        if (totAmt > 0.00)
        {
    ...
    protected void txtQty9_TextChanged(object sender, EventArgs e)
    {
       /* if (txtQty9.Text != "")
        ...
        Double totAmt = calcTotAmt(txtQty9.Text, txtUnitPrice9.Text, txttrendDisc9.Text, txtstax9.Text, txtmrp9.Text);
        if (totAmt > 0.00)
        {
    ...
    protected void txtQty10_TextChanged(object sender, EventArgs e)
    {
      /*  if (txtQty10.Text != "")
        ...
        Double totAmt = calcTotAmt(txtQty10.Text, txtUnitPrice10.Text, txttrendDisc10.Text, txtstax10.Text, txtmrp10.Text);
        if (totAmt > 0.00)
        {
    ...
    protected void txtQty11_TextChanged(object sender, EventArgs e)
    {
        ...
        Double totAmt = calcTotAmt(txtQty11.Text, txtUnitPrice11.Text, txttrendDisc11.Text, txtstax11.Text, txtmrp11.Text);
        if (totAmt > 0.00)
        {
    ...
    protected void txtQty12_TextChanged(object sender, EventArgs e)
    {
        ...
        Double totAmt = calcTotAmt(txtQty12.Text, txtUnitPrice12.Text, txttrendDisc12.Text, txtstax12.Text, txtmrp12.Text);
        if (totAmt > 0.00)
        {
    ...
    {
        DataTable supdata = theHelper.getPurMedicineRec(ddlMfg1.SelectedValue, ddlMedi1.SelectedValue, ddlBatch1.SelectedValue, Session["CoCode"].ToString(), Session["YearCode"].ToString().Trim());
        DropDownList1.SelectedValue = supdata.Rows[0]["SCode"].ToString().Trim();
        ddlsup_selectedIndexChanged(supdata.Rows[0]["SCode"].ToString().Trim());

        DataTable meddata = theHelper.getPurMedicineRecdetl(ddlMfg1.SelectedValue, ddlMedi1.SelectedValue, ddlBatch1.SelectedValue, Session["CoCode"].ToString(), Session["YearCode"].ToString().Trim(), DropDownList1.SelectedValue.ToString());
        if (meddata.Rows.Count > 0)
        {
           ...
           // lbldisc1.Text = meddata.Rows[0]["lesspercent"].ToString();
           // lblstax1.Text = meddata.Rows[0]["taxpercent"].ToString();//
            
            txtmrp1.Text = meddata.Rows[0]["sellamt"].ToString();

            txttrendDisc1.Text = meddata.Rows[0]["lesspercent"].ToString();
            txtstax1.Text = meddata.Rows[0]["taxpercent"].ToString();
            
            txtBill1.Text = meddata.Rows[0]["chno"].ToString();
           /* if (txtlessper.Text != "")
            {
    ...
    {
        DataTable meddata = theHelper.getPurMedicineRecdetl(ddlMfg2.SelectedValue, ddlMedi2.SelectedValue, ddlBatch2.SelectedValue, Session["CoCode"].ToString(), Session["YearCode"].ToString().Trim(), DropDownList1.SelectedValue.ToString());
        if (meddata.Rows.Count > 0)
        {
            ...
            txttrendDisc2.Text = meddata.Rows[0]["lesspercent"].ToString();
            txtstax2.Text = meddata.Rows[0]["taxpercent"].ToString();
            txtmrp2.Text = meddata.Rows[0]["sellamt"].ToString();
            txtBill2.Text = meddata.Rows[0]["chno"].ToString();
        }
        else
        {
            Calendar3.Text = "";
    ...
    {
        DataTable meddata = theHelper.getPurMedicineRecdetl(ddlMfg3.SelectedValue, ddlMedi3.SelectedValue, ddlBatch3.SelectedValue, Session["CoCode"].ToString(), Session["YearCode"].ToString().Trim(), DropDownList1.SelectedValue.ToString());
        if (meddata.Rows.Count > 0)
        {
            ...
            txttrendDisc2.Text = meddata.Rows[0]["lesspercent"].ToString();
            txtstax2.Text = meddata.Rows[0]["taxpercent"].ToString();
            txtBill3.Text = meddata.Rows[0]["chno"].ToString();
            txtmrp3.Text = meddata.Rows[0]["sellamt"].ToString();
        }
        else
        {
            Calendar4.Text = "";
    ...
    {
        DataTable meddata = theHelper.getPurMedicineRecdetl(ddlMfg4.SelectedValue, ddlMedi4.SelectedValue, ddlBatch4.SelectedValue, Session["CoCode"].ToString(), Session["YearCode"].ToString().Trim(), DropDownList1.SelectedValue.ToString());
        if (meddata.Rows.Count > 0)
        {
           ...
           /* if (txtlessper.Text != "")
            ...
            txttrendDisc4.Text = meddata.Rows[0]["lesspercent"].ToString();
            txtstax4.Text = meddata.Rows[0]["taxpercent"].ToString();
            txtmrp4.Text = meddata.Rows[0]["sellamt"].ToString();
            txtBill4.Text = meddata.Rows[0]["chno"].ToString();
        }
        else
        {
            Calendar5.Text = "";
    ...
    {
        DataTable meddata = theHelper.getPurMedicineRecdetl(ddlMfg5.SelectedValue, ddlMedi5.SelectedValue, ddlBatch5.SelectedValue, Session["CoCode"].ToString(), Session["YearCode"].ToString().Trim(), DropDownList1.SelectedValue.ToString());
        if (meddata.Rows.Count > 0)
        {
            ...
            txttrendDisc5.Text = meddata.Rows[0]["lesspercent"].ToString();
            txtstax5.Text = meddata.Rows[0]["taxpercent"].ToString();
            txtmrp5.Text = meddata.Rows[0]["sellamt"].ToString();
            txtBill5.Text = meddata.Rows[0]["chno"].ToString();
        }
        else
        {
            Calendar6.Text = "";
    ...
    {
        DataTable meddata = theHelper.getPurMedicineRecdetl(ddlMfg6.SelectedValue, ddlMedi6.SelectedValue, ddlBatch6.SelectedValue, Session["CoCode"].ToString(), Session["YearCode"].ToString().Trim(), DropDownList1.SelectedValue.ToString());
        if (meddata.Rows.Count > 0)
        {
           ...
           /* if (txtlessper.Text != "")
            ...
            txttrendDisc6.Text = meddata.Rows[0]["lesspercent"].ToString();
            txtstax6.Text = meddata.Rows[0]["taxpercent"].ToString();
            txtmrp6.Text = meddata.Rows[0]["sellamt"].ToString();
            txtBill6.Text = meddata.Rows[0]["chno"].ToString();
        }
        else
        {
            Calendar7.Text = "";
    ...
    {
        DataTable meddata = theHelper.getPurMedicineRecdetl(ddlMfg7.SelectedValue, ddlMedi7.SelectedValue, ddlBatch7.SelectedValue, Session["CoCode"].ToString(), Session["YearCode"].ToString().Trim(), DropDownList1.SelectedValue.ToString());
        if (meddata.Rows.Count > 0)
        {
            ...
            txttrendDisc7.Text = meddata.Rows[0]["lesspercent"].ToString();
            txtstax7.Text = meddata.Rows[0]["taxpercent"].ToString();
            txtmrp7.Text = meddata.Rows[0]["sellamt"].ToString();
            txtBill7.Text = meddata.Rows[0]["chno"].ToString();
        }
        else
        {
            Calendar8.Text = "";
    ...
    {
        DataTable meddata = theHelper.getPurMedicineRecdetl(ddlMfg8.SelectedValue, ddlMedi8.SelectedValue, ddlBatch8.SelectedValue, Session["CoCode"].ToString(), Session["YearCode"].ToString().Trim(), DropDownList1.SelectedValue.ToString());
        if (meddata.Rows.Count > 0)
        {
            ...
            txttrendDisc8.Text = meddata.Rows[0]["lesspercent"].ToString();
            txtstax8.Text = meddata.Rows[0]["taxpercent"].ToString();
            txtmrp8.Text = meddata.Rows[0]["sellamt"].ToString();
            txtBill8.Text = meddata.Rows[0]["chno"].ToString();
        }
        else
        {
            Calendar9.Text = "";
    ...
    {
        DataTable meddata = theHelper.getPurMedicineRecdetl(ddlMfg9.SelectedValue, ddlMedi9.SelectedValue, ddlBatch9.SelectedValue, Session["CoCode"].ToString(), Session["YearCode"].ToString().Trim(), DropDownList1.SelectedValue.ToString());
        if (meddata.Rows.Count > 0)
        {
            ...
            txttrendDisc9.Text = meddata.Rows[0]["lesspercent"].ToString();
            txtstax9.Text = meddata.Rows[0]["taxpercent"].ToString();
            txtmrp9.Text = meddata.Rows[0]["sellamt"].ToString();
            txtBill9.Text = meddata.Rows[0]["chno"].ToString();
            txtmrp9.Text = "";
        }
        else
        {
    ...
    {
        DataTable meddata = theHelper.getPurMedicineRecdetl(ddlMfg10.SelectedValue, ddlMedi10.SelectedValue, ddlBatch10.SelectedValue, Session["CoCode"].ToString(), Session["YearCode"].ToString().Trim(), DropDownList1.SelectedValue.ToString());
        if (meddata.Rows.Count > 0)
        {
            ...
            txttrendDisc10.Text = meddata.Rows[0]["lesspercent"].ToString();
            txtstax10.Text = meddata.Rows[0]["taxpercent"].ToString();
            txtmrp10.Text = meddata.Rows[0]["sellamt"].ToString();
            txtBill10.Text = meddata.Rows[0]["chno"].ToString();
        }
        else
        {
            Calendar11.Text = "";
    ...
    {
        DataTable meddata = theHelper.getPurMedicineRecdetl(ddlMfg11.SelectedValue, ddlMedi11.SelectedValue, ddlBatch11.SelectedValue, Session["CoCode"].ToString(), Session["YearCode"].ToString().Trim(), DropDownList1.SelectedValue.ToString());
        if (meddata.Rows.Count > 0)
        {
            ...
            txttrendDisc11.Text = meddata.Rows[0]["lesspercent"].ToString();
            txtstax11.Text = meddata.Rows[0]["taxpercent"].ToString();
            txtmrp11.Text = meddata.Rows[0]["sellamt"].ToString();
            txtBill11.Text = meddata.Rows[0]["chno"].ToString();
        }
        else
        {
            Calendar12.Text = "";
    ...
    {
        DataTable meddata = theHelper.getPurMedicineRecdetl(ddlMfg12.SelectedValue, ddlMedi12.SelectedValue, ddlBatch12.SelectedValue, Session["CoCode"].ToString(), Session["YearCode"].ToString().Trim(), DropDownList1.SelectedValue.ToString());
        if (meddata.Rows.Count > 0)
        {
           ...
           /* if (txtlessper.Text != "")
            ...
            txttrendDisc12.Text = meddata.Rows[0]["lesspercent"].ToString();
            txtstax12.Text = meddata.Rows[0]["taxpercent"].ToString();
            txtmrp12.Text = meddata.Rows[0]["sellamt"].ToString();
            txtBill12.Text = meddata.Rows[0]["chno"].ToString();
        }
        else
        {
            Calendar13.Text = "";
    ...
    {
        Double totAmt = calculateTotAmt(txtQty1.Text, txtUnitPrice1.Text, txtmrp1.Text);
        if (totAmt > 0.00)
        {
            txtTotalPrice1.Text = totAmt.ToString();
        }
    ...
    {
        Double totAmt = calculateTotAmt(txtQty2.Text, txtUnitPrice2.Text, txtmrp2.Text);
        if (totAmt > 0.00)
        {
            txtTotalPrice2.Text = totAmt.ToString();
        }
    ...
    {
        Double totAmt = calculateTotAmt(txtQty3.Text, txtUnitPrice3.Text, txtmrp3.Text);
        if (totAmt > 0.00)
        {
            txtTotalPrice3.Text = totAmt.ToString();
        }
    ...
    {
        Double totAmt = calculateTotAmt(txtQty4.Text, txtUnitPrice4.Text, txtmrp4.Text);
        if (totAmt > 0.00)
        {
            txtTotalPrice4.Text = totAmt.ToString();
        }
    ...
    {
        Double totAmt = calculateTotAmt(txtQty5.Text, txtUnitPrice5.Text, txtmrp5.Text);
        if (totAmt > 0.00)
        {
            txtTotalPrice5.Text = totAmt.ToString();
        }
    ...
    {
        Double totAmt = calculateTotAmt(txtQty6.Text, txtUnitPrice6.Text, txtmrp6.Text);
        if (totAmt > 0.00)
        {
            txtTotalPrice6.Text = totAmt.ToString();
        }
    ...
    {
        Double totAmt = calculateTotAmt(txtQty7.Text, txtUnitPrice7.Text, txtmrp7.Text);
        if (totAmt > 0.00)
        {
            txtTotalPrice7.Text = totAmt.ToString();
        }
    ...
    {
        Double totAmt = calculateTotAmt(txtQty8.Text, txtUnitPrice8.Text, txtmrp8.Text);
        if (totAmt > 0.00)
        {
            txtTotalPrice8.Text = totAmt.ToString();
        }
    ...
    {
        Double totAmt = calculateTotAmt(txtQty9.Text, txtUnitPrice9.Text, txtmrp9.Text);
        if (totAmt > 0.00)
        {
            txtTotalPrice9.Text = totAmt.ToString();
        }
    ...
    {
        Double totAmt = calculateTotAmt(txtQty10.Text, txtUnitPrice10.Text, txtmrp10.Text);
        if (totAmt > 0.00)
        {
            txtTotalPrice10.Text = totAmt.ToString();
        }
    ...
    {
        Double totAmt = calculateTotAmt(txtQty11.Text, txtUnitPrice11.Text, txtmrp11.Text);
        if (totAmt > 0.00)
        {
            txtTotalPrice11.Text = totAmt.ToString();
        }
    ...
    {
        Double totAmt = calculateTotAmt(txtQty12.Text, txtUnitPrice12.Text, txtmrp12.Text);
        if (totAmt > 0.00)
        {
            txtTotalPrice12.Text = totAmt.ToString();
        }
    ...
    protected Double calcTotAmt(string quantity, string trendprice, string discount, string sertax,string mrp)
    {
        int qty = 0;
        Double trndprc = 0.00;
        Double disc = 0.00;
       ...
       /* if (mrp != "")
        ...
        {
            disc = (Convert.ToDouble(discount) / 100) * trndprc * qty;
        }
        if (sertax == "" || sertax == "0" || sertax == "0.00")
        {
            tax = 0.00;
        }
        else
        {
            tax = (Convert.ToDouble(sertax) / 100) * mrpprc * qty;
        }*/
    ...
    protected void perc_textchange(object sender, EventArgs e)
    {
        ...
        for (int i = 0, t = 1; i < 12; i++, t++)
        {
            ...
            s3 = (TextBox)Page.FindControl("ctl00$ContentPlaceHolder1$txtmrp" + t.ToString());
            ...
            taxAmt = calStax(trndprc,mrp);
            totAmt = calculateTotAmt(trndprc, qty,mrp);
    ...
    private Double calculateTotAmt(string trndprice, string qty,string mrp)
    {
        Double trendprice = 0.00;
       ...
       /* if (txtlessper.Text != "")
        ...
        txamt = (tax * mrpprc) / 100;
        less = (lessper * trendprice) / 100;*/
        if (qty != "")
        {
            amt =quantity * trendprice;
        }
        else
        {
            amt = 0.00;
    ...
    private Double calStax(string trndprc,string mrp)
    {
        Double trendprice = 0.00;
        Double tax = 0.00;
        Double mrpprc = 0.00;
    ...
    protected void ddlsup_selectedIndexChanged(string sup)
    {
        ...
        for (int i = 2; i <= 12; i++)
        {
            DropDownList ddlMedicine = (DropDownList)Page.FindControl("ctl00$ContentPlaceHolder1$ddlMedi" + i.ToString());
            ddlMedicine.Items.Clear();
            ddlMedicine.DataSource = theHelper.DropdownMedicine(sup, Session["CoCode"].ToString().Trim(), Session["YearCode"].ToString().Trim());
            ddlMedicine.DataTextField = "MedicineName";
            ddlMedicine.DataValueField = "MedicineID";
            ddlMedicine.DataBind();
            ddlMedicine.Items.Insert(0, new ListItem("--Select--", "0"));
