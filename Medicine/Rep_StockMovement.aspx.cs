...
public partial class Rep_StockMovement : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Objmain.checkaccss(Session["CoCode"].ToString(), Session["UserRoleID"].ToString().Trim(), "STOCK MOVEMENT REGISTER", checkAccessType.ViewAction) == false)
        {
    ...
    protected void btnproceed_Click(object sender, EventArgs e)
    {
        ...
        Session["dt"] = objreport.GetStockMovementRegister(txtfromdt.Text, txttodt.Text, grp);
        Session["from"] = txtfromdt.Text;
        Session["to"] = txttodt.Text;
        Response.Redirect("View_StockMovement.aspx");
