<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="PurchaseInvoiceReport.aspx.cs" Inherits="Medicine_PurchaseInvoiceReport" %>
...
<%-- 
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
            <asp:Label ID="Label1" runat="server">Purchase Invoice Report</asp:Label>
        </div>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <div class="formbox" style="width:1200px">
