<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="Rep_StockMovement.aspx.cs" Inherits="Rep_StockMovement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function DisableBackButton() {
         ...
         <asp:Label ID="Label1" runat="server">Stock Movement Register</asp:Label>
     </div>
