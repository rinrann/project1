<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="DialysisSlip.aspx.cs" Inherits="DayCare_DialysisSlip" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    function Calling() {
        ...
        $("input[id$='Button2']").click(function () {
            if ($("input[id$='ltrReport']").val() == '') {
                alert('Please Generate Report !');
                $("input[id$='ltrReport']").focus();
                $("input[id$='ltrReport']").addClass('textboxerr');
                return false;
            }
            else {
                $("input[id$='ltrReport']").removeClass('textboxerr');
            }
...
<%--For Busy Loader .............................--%>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Dialysis Slip</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
