<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="Rep_SampleCollection.aspx.cs" Inherits="Rep_SampleCollection" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function DisableBackButton() {
         ...
         <asp:Label ID="Label1" runat="server">Sample Collection Register</asp:Label>
     </div>
                   ...
                   <tr>
                       ...
                       <td>
                           <asp:RadioButtonList ID="rbl" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" OnSelectedIndexChanged="rbl_SelectedIndexChanged">
                               <asp:ListItem Text="All" Value="Y" Selected="True"></asp:ListItem>
                               <asp:ListItem Text="Individual" Value="N"></asp:ListItem>
                           </asp:RadioButtonList>
                       </td>
                   </tr>
                   <tr id="tr_indi" runat="server">
                       <td>Choose Sample</td>
                       <td>
                           <asp:DropDownList ID="ddlindi" runat="server"></asp:DropDownList>
                       </td>
                   </tr>
                   <tr>
                       <td>From Date :</td>
