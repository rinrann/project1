<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="Rep_InvestGrpwisecollection.aspx.cs" Inherits="Rep_InvestGrpwisecollection" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/UC/UCInvestigationGroup.ascx" TagName="UCInvestigationGroup" TagPrefix="InvGrp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function DisableBackButton() {
         ...
         <asp:Label ID="Label1" runat="server">Investigation Group Wise Collection Register</asp:Label>
     </div>
                                                            ...
                                                            <table id="trGrp" cellspacing="0" cellpadding="0" border="0" runat="server">
                                                                <tr>
                                                                    <td style="width: 1px" width="1">
                                                                        <InvGrp:UCInvestigationGroup ID="InvGroup" runat="server" />
                                                                    </td>
                                                                    <td align="center">
                                                                        &nbsp;
                                                                    </td>
