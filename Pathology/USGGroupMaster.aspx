<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="USGGroupMaster.aspx.cs" Inherits="Pathology_USGGroupMaster" %>
...
<script type="text/javascript" language="javascript">
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <div class="pageheader">
         <asp:Label ID="Label1" runat="server">USG Group Master</asp:Label>
     </div>
     ...
     <div class="form-sec">
            ...
            <div class="form-sec-row">
                ...
                <asp:TextBox ID="txttemname" runat="server" CssClass="textbox-medium1" 
                   ></asp:TextBox>
                <cc1:AutoCompleteExtender ServiceMethod="SearchUSGGroup" OnClientItemSelected="autoCompleteEx_ItemSelected" MinimumPrefixLength="1"
    ...
    <asp:View ID="View2" runat="server">
     <div class="listing"    style='width:100%; height:250px; overflow:auto;'>
         <asp:GridView id="GridView1"  CssClass="grid" PagerStyle-CssClass="pgr" DataKeyNames ="GroupCode,GroupName" runat="server" AutoGenerateColumns="False"
             ...
             OnRowDeleting="GridView1_RowDeleting" Width="100%">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Group Code">
                        <ItemTemplate>
                            <asp:Label ID="lblcode" runat="server" Text='<%# Bind("GroupCode") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
