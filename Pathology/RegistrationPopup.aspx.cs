...
{
    PH_RegistrationPopup thereg = new PH_RegistrationPopup(ConfigurationSettings.AppSettings["ConnectionString"].ToString());
    ...
    {
        GridView1.DataSource = thereg.GridPopup(Session["CoCode"].ToString().Trim(),txtreg.Text.Trim(), txtname.Text.Trim(), txtph.Text.Trim(),txtaddress.Text.Trim());
        GridView1.DataBind();
    }
