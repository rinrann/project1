<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAll/MasterPageAll.master" AutoEventWireup="true" CodeFile="CostTestGroup.aspx.cs" Inherits="Pathology_CostTestGroup" %>
  ...
  <asp:UpdateProgress ID="UpdateProgress1" runat="server">
    ...
    <ContentTemplate>
        <div class="pageheader">
         <asp:Label ID="Label1" runat="server">Cost Per Group Test</asp:Label>
     </div>
     <div class="formbox">
        <div class="form-sec">
            <div class="error">
