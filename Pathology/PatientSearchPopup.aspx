<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PatientSearchPopup.aspx.cs" Inherits="Pathology_PatientSearchPopup" %>
...
<head id="Head1" runat="server">
  ...
  margin-right:auto; 
    ...
    <script type="text/javascript" >
        ...
        function Calling() {
            var date = new Date();
            $("input[id$='txtname']").datepicker({ dateFormat: 'dd/mm/yy' });
    ...
    <%--For Busy Loader End.............................--%>
       ...
       <tr>
             ...
             <label class="pname"><strong>Name :</strong></label> 
                ...
                <td>
                    <div class="form-sec-row"> 
             <label class="pname"><strong>Date :</strong></label> <asp:TextBox ID="txtname" runat="server" CssClass="textbox-medium1" Width="138px" ></asp:TextBox>
            </div>
</td>
                <td>
                             <div class="form-sec-row"> 
             <label class="pname"><strong>Reagent :</strong></label> <asp:TextBox ID="txtphone" runat="server" CssClass="textbox-medium1" Width="138px" ></asp:TextBox>
            </div>                  
</td>
<td>
                             <div class="form-sec-row"> 
             ...
             <tr align="center">                       
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Father/Husband Name">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblfather" runat="server" Text='<%# Bind("father_husband") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
